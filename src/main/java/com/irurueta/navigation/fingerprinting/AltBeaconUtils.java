...
public class AltBeaconUtils {
     ...
     */
    public static double getDistance(double coefficient1, double coefficient2,
            double coefficient3, double ratio) {
        //d = coefficient1 * ratio^coefficient2 + coefficient3
     ...
     */
    public static double getDistance(double coefficient1, double coefficient2,
            double coefficient3, double receivedPower, double transmittedPower) {
     ...
     * @return power ratio.
     */
    public static double getRatio(double coefficient1, double coefficient2,
            double coefficient3, double distance) {
        //d = coefficient1 * ratio^coefficient2 + coefficient3
     ...
     * @return received power expressed in mW.
     */
    public static double getReceivedPower(double coefficient1, double coefficient2,
            double coefficient3, double distance, double transmittedPower) {
     ...
     * @return transmitted power expressed in mW.
     */
    public static double getTransmittedPower(double coefficient1,
            double coefficient2, double coefficient3, double distance,
     ...
     * @return AltBeacon's 1st coefficient.
     */
    public static double getCoefficient1WithFrequency(double frequency,
