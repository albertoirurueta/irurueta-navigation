 ...
 */
public class RANSACRobustWifiAccessPointPowerAndPositionEstimator3D extends
                ...
                new RANSACRobustEstimator<>(
                        new RANSACRobustEstimatorListener<Solution<Point3D>>() {
                            ...
                            public boolean isReady() {
                                return RANSACRobustWifiAccessPointPowerAndPositionEstimator3D.this.isReady();
                            }
                            ...
                            public void onEstimateStart(RobustEstimator<Solution<Point3D>> estimator) {
                                if (mListener != null) {
                                    mListener.onEstimateStart(
                                            RANSACRobustWifiAccessPointPowerAndPositionEstimator3D.this);
                                }
                            }
                            ...
                            public void onEstimateNextIteration(RobustEstimator<Solution<Point3D>> estimator, int iteration) {
                                if (mListener != null) {
                                    mListener.onEstimateNextIteration(
                                            RANSACRobustWifiAccessPointPowerAndPositionEstimator3D.this, iteration);
                                }
                            }
                            ...
                            public void onEstimateProgressChange(RobustEstimator<Solution<Point3D>> estimator, float progress) {
                                if (mListener != null) {
                                    mListener.onEstimateProgressChange(
                                            RANSACRobustWifiAccessPointPowerAndPositionEstimator3D.this, progress);
                                }
                            }
                        });
