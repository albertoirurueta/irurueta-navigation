...
public abstract class RobustWifiAccessPointPowerAndPositionEstimator2D extends
     ...
     */
    protected RssiRadioSourceEstimator2D mInnerEstimator =
            new RssiRadioSourceEstimator2D();

    /**
     * Subset of readings used by inner estimator.
     */
    private List<RssiReadingLocated<WifiAccessPoint, Point2D>> mInnerReadings = new ArrayList<>();
    ...
    public WifiAccessPointWithPowerAndLocated2D getEstimatedAccessPoint() {
        List<? extends RssiReadingLocated<WifiAccessPoint, Point2D>> readings = getReadings();
