...
public abstract class WifiAccessPointPowerAndPositionEstimator<P extends Point> {
     ...
     */
    private List<? extends WifiRssiReadingLocated<WifiAccessPoint, P>> mReadings;
    ...
    private void setupFitterWithPathLossExponentDisabled() throws FittingException {
        ...
        //reading
        WifiRssiReadingLocated<WifiAccessPoint, P> reading = mReadings.get(0);
        ...
        mFitter.setFunctionEvaluator(new LevenbergMarquardtMultiDimensionFunctionEvaluator() {
            ...
            public double[] createInitialParametersArray() {
                ...
                if (mInitialPosition == null) {
                    ...
                    for (WifiRssiReadingLocated<WifiAccessPoint, P> reading : mReadings) {
