...
public class WifiRangingReadingLocated<P extends Point> extends WifiRangingReading {
     ...
     * or position is null.
     */
    public WifiRangingReadingLocated(WifiAccessPoint accessPoint, double distance,
