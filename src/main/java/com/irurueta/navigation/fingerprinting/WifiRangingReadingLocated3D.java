...
public class WifiRangingReadingLocated3D extends WifiRangingReadingLocated<Point3D> {
     ...
     * or position is null.
     */
    public WifiRangingReadingLocated3D(WifiAccessPoint accessPoint, double distance,
