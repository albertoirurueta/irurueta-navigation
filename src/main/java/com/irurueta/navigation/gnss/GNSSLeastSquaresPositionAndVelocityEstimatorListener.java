...
public interface GNSSLeastSquaresPositionAndVelocityEstimatorListener {
     ...
     */
    void onEstimateStart(final GNSSLeastSquaresPositionAndVelocityEstimator estimator);
     ...
     * @param estimator estimator raising the event.
     */
    void onEstimateEnd(final GNSSLeastSquaresPositionAndVelocityEstimator estimator);
}
