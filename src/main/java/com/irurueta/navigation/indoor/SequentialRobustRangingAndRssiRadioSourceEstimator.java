 ...
 * exponent of a radio source (e.g. WiFi access point or bluetooth beacon), by discarging
...
public abstract class SequentialRobustRangingAndRssiRadioSourceEstimator<S extends RadioSource,
    ...
    public boolean isReady() throws LockedException {
        ...
        return mRangingEstimator.isReady() && mRssiEstimator.isReady();
    }
     ...
     */
    protected abstract void buildRssiEstimatorIfNeeded();
