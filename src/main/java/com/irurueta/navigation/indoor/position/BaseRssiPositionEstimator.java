...
public abstract class BaseRssiPositionEstimator<P extends Point,
     ...
     */
    public BaseRssiPositionEstimator(RssiFingerprint<? extends RadioSource,
    ...
    public BaseRssiPositionEstimator(List<? extends RssiFingerprintLocated<? extends RadioSource,
            ...
            ? extends RssiReading<? extends RadioSource>> fingerprint,
            L listener) {
        this(locatedFingerprints, listener);
        internalSetFingerprint(fingerprint);
    }
     ...
     */
    public BaseRssiPositionEstimator(int minNearestFingerprints,
    ...
    public BaseRssiPositionEstimator(List<? extends RssiFingerprintLocated<? extends RadioSource,
            ...
            ? extends RssiReading<? extends RadioSource>> fingerprint,
            int minNearestFingerprints, int maxNearestFingerprints) {
        this(locatedFingerprints, fingerprint);
        internalSetMinMaxNearestFingerprints(minNearestFingerprints,
                maxNearestFingerprints);
    }
    ...
    public BaseRssiPositionEstimator(List<? extends RssiFingerprintLocated<? extends RadioSource,
            ...
            int minNearestFingerprints, int maxNearestFingerprints,
            L listener) {
        this(locatedFingerprints, fingerprint, listener);
        internalSetMinMaxNearestFingerprints(minNearestFingerprints,
                maxNearestFingerprints);
    }
     ...
     */
    public BaseRssiPositionEstimator(double pathLossExponent) {
     ...
     * @param listener listener in charge of handling events.
     */
    public BaseRssiPositionEstimator(double pathLossExponent, L listener) {
        this(listener);
        mPathLossExponent = pathLossExponent;
    }
    ...
    public BaseRssiPositionEstimator(List<? extends RssiFingerprintLocated<? extends RadioSource,
            ? extends RssiReading<? extends RadioSource>, P>> locatedFingerprints,
            double pathLossExponent, L listener) {
        this(locatedFingerprints, listener);
        mPathLossExponent = pathLossExponent;
    }
    ...
    public BaseRssiPositionEstimator(int minNearestFingerprints,
        ...
        this(minNearestFingerprints, maxNearestFingerprints);
        mPathLossExponent = pathLossExponent;
    }
    ...
    public BaseRssiPositionEstimator(int minNearestFingerprints,
            int maxNearestFingerprints, double pathLossExponent,
            L listener) {
        this(minNearestFingerprints, maxNearestFingerprints, listener);
        mPathLossExponent = pathLossExponent;
    }
    ...
    public BaseRssiPositionEstimator(List<? extends RssiFingerprintLocated<? extends RadioSource,
            ...
            int minNearestFingerprints, int maxNearestFingerprints,
            double pathLossExponent) {
        this(locatedFingerprints, minNearestFingerprints, maxNearestFingerprints);
        mPathLossExponent = pathLossExponent;
    }
    ...
    public BaseRssiPositionEstimator(RssiFingerprint<? extends RadioSource,
            ...
            int minNearestFingerprints, int maxNearestFingerprints,
            double pathLossExponent) {
        this(fingerprint, minNearestFingerprints, maxNearestFingerprints);
        mPathLossExponent = pathLossExponent;
    }
    ...
    public BaseRssiPositionEstimator(RssiFingerprint<? extends RadioSource,
            ...
            int minNearestFingerprints, int maxNearestFingerprints,
            double pathLossExponent, L listener) {
        this(fingerprint, minNearestFingerprints, maxNearestFingerprints, listener);
        mPathLossExponent = pathLossExponent;
    }
    ...
    public BaseRssiPositionEstimator(List<? extends RssiFingerprintLocated<? extends RadioSource,
            ...
            int minNearestFingerprints, int maxNearestFingerprints,
            double pathLossExponent) {
        this(locatedFingerprints, fingerprint, minNearestFingerprints,
                maxNearestFingerprints);
        mPathLossExponent = pathLossExponent;
    }
