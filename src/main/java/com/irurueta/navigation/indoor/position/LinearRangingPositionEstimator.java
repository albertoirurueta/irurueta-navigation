...
public abstract class LinearRangingPositionEstimator<P extends Point> extends
     ...
     */
    public LinearRangingPositionEstimator(RangingPositionEstimatorListener<P> listener) {
        super(listener);
        init();
    }
