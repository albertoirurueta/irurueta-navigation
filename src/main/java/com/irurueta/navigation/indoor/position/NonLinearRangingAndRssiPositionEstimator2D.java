...
public class NonLinearRangingAndRssiPositionEstimator2D extends
     ...
     */
    public NonLinearRangingAndRssiPositionEstimator2D(List<? extends RadioSourceLocated<Point2D>> sources,
            Fingerprint<? extends RadioSource, ? extends RangingAndRssiReading<? extends RadioSource>> fingerprint) {
        super();
        init();
        internalSetSources(sources);
     ...
     */
    public NonLinearRangingAndRssiPositionEstimator2D(Point2D initialPosition) {
