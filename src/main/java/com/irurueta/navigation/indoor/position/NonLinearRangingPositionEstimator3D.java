...
public class NonLinearRangingPositionEstimator3D extends
     ...
     */
    public NonLinearRangingPositionEstimator3D(List<? extends RadioSourceLocated<Point3D>> sources,
            Fingerprint<? extends RadioSource, ? extends RangingReading<? extends RadioSource>> fingerprint) {
        super();
        init();
        internalSetSources(sources);
     ...
     */
    public NonLinearRangingPositionEstimator3D(
            RangingPositionEstimatorListener<Point3D> listener) {
        super(listener);
        init();
    }
     ...
     */
    public NonLinearRangingPositionEstimator3D(Point3D initialPosition) {
     ...
     */
    private void init() {
        mTrilaterationSolver = new NonLinearLeastSquaresTrilateration3DSolver(
