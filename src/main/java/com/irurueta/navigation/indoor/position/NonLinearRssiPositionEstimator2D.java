...
public class NonLinearRssiPositionEstimator2D extends
     ...
     */
    public NonLinearRssiPositionEstimator2D(List<? extends RadioSourceLocated<Point2D>> sources,
            Fingerprint<? extends RadioSource, ? extends RssiReading<? extends RadioSource>> fingerprint) {
        super();
        init();
        internalSetSources(sources);
     ...
     */
    public NonLinearRssiPositionEstimator2D(Point2D initialPosition) {
