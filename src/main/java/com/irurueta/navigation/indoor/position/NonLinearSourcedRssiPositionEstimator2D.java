...
public class NonLinearSourcedRssiPositionEstimator2D extends
        NonLinearSourcedRssiPositionEstimator<Point2D> {

    /**
     * Constructor.
     */
    public NonLinearSourcedRssiPositionEstimator2D() { }
    ...
    protected double evaluate(int i, double[] point, double[] params, double[] derivatives) throws EvaluationException {
