...
public class PROMedSRobustPositionEstimator2D extends RobustPositionEstimator2D {
     ...
     * Constructor.
     */
    public PROMedSRobustPositionEstimator2D() {
        super();
        init();
    }
     ...
     *                      source.
     */
    public PROMedSRobustPositionEstimator2D(double[] qualityScores) {
        this();
