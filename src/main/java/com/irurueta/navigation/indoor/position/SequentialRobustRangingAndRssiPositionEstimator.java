...
public abstract class SequentialRobustRangingAndRssiPositionEstimator<P extends Point> {
    ...
    public P[] getPositions() {
        return mRangingEstimator != null ? mRangingEstimator.getPositions() : null;
    }
    ...
    public double[] getDistances() {
        return mRangingEstimator != null ? mRangingEstimator.getDistances() : null;
    }
     ...
     * @throws LockedException if estimator is locked.
     */
    protected void setupEstimators() throws LockedException {
