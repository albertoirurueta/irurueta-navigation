...
public class SourcedRssiPositionEstimator3D extends SourcedRssiPositionEstimator<Point3D> {
     ...
     * fingerprints or readings within provided fingerprints (for 3D position estimation at
     ...
     * estimation 3 located total readings are required among all fingerprints).
     */
    public SourcedRssiPositionEstimator3D(List<? extends RssiFingerprintLocated<? extends RadioSource,
            ? extends RssiReading<? extends RadioSource>, Point3D>> locatedFingerprints,
            SourcedRssiPositionEstimatorListener<Point3D> listener) {
     ...
     */
    public SourcedRssiPositionEstimator3D(RssiFingerprint<? extends RadioSource,
     ...
     * readings within provided fingerprints (for 3D position estimation at least 2
     ...
     */
    public SourcedRssiPositionEstimator3D(int minNearestFingerprints,
     ...
     */
    public SourcedRssiPositionEstimator3D(double pathLossExponent) {
