...
public class MSACRobustRssiRadioSourceEstimator3D<S extends RadioSource> extends
     ...
     *                        source position.
     */
    public MSACRobustRssiRadioSourceEstimator3D(Point3D initialPosition) {
                            ...
                            public void onEstimateNextIteration(RobustEstimator<Solution<Point3D>> estimator, int iteration) {
                                if (mListener != null) {
                                    mListener.onEstimateNextIteration(
                                            MSACRobustRssiRadioSourceEstimator3D.this, iteration);
                                }
                            }
                            ...
                            public void onEstimateProgressChange(RobustEstimator<Solution<Point3D>> estimator, float progress) {
                                if (mListener != null) {
                                    mListener.onEstimateProgressChange(
                                            MSACRobustRssiRadioSourceEstimator3D.this, progress);
                                }
                            }
                        });
