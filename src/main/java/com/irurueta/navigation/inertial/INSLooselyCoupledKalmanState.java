...
/**
 * Kalman filter state for loosely coupled INS/GNS extended kalman filter.
 */
public class INSLooselyCoupledKalmanState implements Serializable, Cloneable {
     ...
     */
    public INSLooselyCoupledKalmanState(final Matrix bodyToEcefCoordinateTransformationMatrix,
     ...
     */
    public INSLooselyCoupledKalmanState(final CoordinateTransformation c,
     ...
     * @throws IllegalArgumentException if provided covariance matrix is not 15x15.
     */
    public INSLooselyCoupledKalmanState(final ECEFFrame frame,
                                        final double accelerationBiasX,
                                        final double accelerationBiasY,
                                        final double accelerationBiasZ,
                                        final double gyroBiasX,
