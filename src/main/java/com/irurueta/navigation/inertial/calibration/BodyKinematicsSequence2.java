 ...
 */
public class BodyKinematicsSequence2<T extends TimedBodyKinematics>
     ...
     * Constructor.
     */
    public BodyKinematicsSequence2() {
    }
     ...
     *              this sequence.
     */
    public BodyKinematicsSequence2(final List<T> items) {
        mItems = items;
    }
     ...
     */
    public BodyKinematicsSequence2(
            final BodyKinematicsSequence2<T> input) {
        copyFrom(input);
    }
     ...
     * @param input instance to copy data from.
     */
    public void copyFrom(BodyKinematicsSequence2<T> input) {
     ...
     */
    public void copyTo(final BodyKinematicsSequence2<T> output) {
    ...
    public boolean equals(Object o) {
        ...
        BodyKinematicsSequence2<?> that = (BodyKinematicsSequence2<?>) o;
    ...
    protected Object clone() throws CloneNotSupportedException {
        ...
        final BodyKinematicsSequence2<T> result =
                (BodyKinematicsSequence2<T>) super.clone();
        copyTo(result);
        return result;
    }
