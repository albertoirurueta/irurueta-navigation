    ...
    public void calibrate() throws LockedException, NotReadyException, CalibrationException {
        ...
        final PROMedSRobustEstimator<PreliminaryResult> innerEstimator =
                new PROMedSRobustEstimator<>(new PROMedSRobustEstimatorListener<PreliminaryResult>() {
                    ...
                    @Override
                    public boolean isReady() {
                        return PROMedSRobustTurntableGyroscopeCalibrator.this.isReady();
                    }
                    ...
                    public void onEstimateStart(
                        ...
                        if (mListener != null) {
                            mListener.onCalibrateStart(PROMedSRobustTurntableGyroscopeCalibrator.this);
                        }
                    }
                    ...
                    public void onEstimateEnd(
                            final RobustEstimator<PreliminaryResult> estimator) {
                        if (mListener != null) {
                            mListener.onCalibrateEnd(PROMedSRobustTurntableGyroscopeCalibrator.this);
                        }
                    }
