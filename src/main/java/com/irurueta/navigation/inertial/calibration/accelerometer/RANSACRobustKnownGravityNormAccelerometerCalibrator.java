 ...
 * orientations and zero velocity when common z-axis is assumed, otherwise
 * at least 13 measurements are required.
 * <p>
 ...
 */
public class RANSACRobustKnownGravityNormAccelerometerCalibrator extends
                ...
                new RANSACRobustEstimator<>(
                        new RANSACRobustEstimatorListener<PreliminaryResult>() {
                            ...
                            public boolean isReady() {
                                return RANSACRobustKnownGravityNormAccelerometerCalibrator.super.isReady();
                            }
