...
public abstract class AccelerometerAndGyroscopeIntervalDetectorThresholdFactorOptimizer extends
    ...
    /**
     * A measurement generator for Accelerometer + gyroscope calibrators.
     */
     ...
     * quality scores.
     *
     * @param accelerometerQualityScoreMapper mapper to convert measurements into quality scores.
     * @throws LockedException if optimizer is already running.
     */
     ...
     * into quality scores.
     *
     * @param gyroscopeQualityScoreMapper mapper to convert seqiemces into quality scores.
     * @throws LockedException if optimizer is already running.
     */
