 ...
 */
public class DefaultMagnetometerQualityScoreMapper implements
     ...
     */
    @Override
    public double map(final StandardDeviationBodyMagneticFluxDensity value) {
        return 1.0 / (1.0 + value.getMagneticFluxDensityStandardDeviation());
    }
}
