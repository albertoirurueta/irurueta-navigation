 ...
 */
public interface OrderedStandardDeviationFrameBodyMagneticFluxDensityMagnetometerCalibrator extends
     ...
     * frames (positions, orientations and velocities).
     */
    List<StandardDeviationFrameBodyMagneticFluxDensity> getMeasurements();
