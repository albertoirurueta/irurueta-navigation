 ...
 * {@link StandardDeviationFrameBodyMagneticFluxDensity} measurements.
 */
public interface UnorderedStandardDeviationFrameBodyMagneticFluxDensityMagnetometerCalibrator extends
     ...
     * frames (positions, orientations and velocities).
     */
    Collection<? extends StandardDeviationFrameBodyMagneticFluxDensity> getMeasurements();
