...
public class InhomogeneousLinearLeastSquaresLateration3DSolver extends
     ...
     */
    public InhomogeneousLinearLeastSquaresLateration3DSolver(Point3D[] positions, double[] distances) {
     ...
     */
    public InhomogeneousLinearLeastSquaresLateration3DSolver(LaterationSolverListener<Point3D> listener) {
        super(listener);
    }
     ...
     */
    public InhomogeneousLinearLeastSquaresLateration3DSolver(Sphere[] spheres) {
        super();
