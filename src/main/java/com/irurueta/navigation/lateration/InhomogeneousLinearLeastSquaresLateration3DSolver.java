...
public class InhomogeneousLinearLeastSquaresLateration3DSolver extends
     ...
     * Constructor.
     */
    public InhomogeneousLinearLeastSquaresLateration3DSolver() {
        super();
    }
     ...
     */
    public InhomogeneousLinearLeastSquaresLateration3DSolver(final Point3D[] positions, final double[] distances) {
     ...
     */
    public InhomogeneousLinearLeastSquaresLateration3DSolver(final LaterationSolverListener<Point3D> listener) {
        super(listener);
    }
     ...
     */
    public InhomogeneousLinearLeastSquaresLateration3DSolver(final Sphere[] spheres) {
        super();
