...
public class LMedSRobustLateration3DSolver extends RobustLateration3DSolver {
     ...
     */
    public LMedSRobustLateration3DSolver(RobustLaterationSolverListener<Point3D> listener) {
        super(listener);
    }
     ...
     */
    public LMedSRobustLateration3DSolver(Point3D[] positions, double[] distances) {
     ...
     */
    public LMedSRobustLateration3DSolver(Sphere[] spheres) {
        super(spheres);
    }
        ...
        LMedSRobustEstimator<Point3D> innerEstimator =
                new LMedSRobustEstimator<>(new LMedSRobustEstimatorListener<Point3D>() {
                    ...
                    public void onEstimateStart(RobustEstimator<Point3D> estimator) {
                        if (mListener != null) {
                            mListener.onSolveStart(LMedSRobustLateration3DSolver.this);
                        }
                    }
                    ...
                    public void onEstimateEnd(RobustEstimator<Point3D> estimator) {
                        if (mListener != null) {
                            mListener.onSolveEnd(LMedSRobustLateration3DSolver.this);
                        }
                    }
                    ...
                    public void onEstimateNextIteration(RobustEstimator<Point3D> estimator, int iteration) {
                        if (mListener != null) {
                            mListener.onSolveNextIteration(LMedSRobustLateration3DSolver.this,
                                    iteration);
                        }
                    }
