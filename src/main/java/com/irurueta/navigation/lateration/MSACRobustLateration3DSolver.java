...
public class MSACRobustLateration3DSolver extends RobustLateration3DSolver {
     ...
     */
    public MSACRobustLateration3DSolver(final RobustLaterationSolverListener<Point3D> listener) {
        super(listener);
    }
    ...
    public Point3D solve() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new MSACRobustEstimator<>(new MSACRobustEstimatorListener<Point3D>() {
            ...
            public void onEstimateNextIteration(final RobustEstimator<Point3D> estimator, final int iteration) {
                if (listener != null) {
                    listener.onSolveNextIteration(MSACRobustLateration3DSolver.this, iteration);
                }
            }
            ...
            public void onEstimateProgressChange(final RobustEstimator<Point3D> estimator, final float progress) {
                if (listener != null) {
                    listener.onSolveProgressChange(MSACRobustLateration3DSolver.this, progress);
                }
            }
        });
