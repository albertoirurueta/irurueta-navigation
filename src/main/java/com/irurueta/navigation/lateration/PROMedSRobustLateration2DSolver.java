...
public class PROMedSRobustLateration2DSolver extends RobustLateration2DSolver {
     ...
     */
    public PROMedSRobustLateration2DSolver(Point2D[] positions, double[] distances) {
     ...
     */
    public PROMedSRobustLateration2DSolver(Circle[] circles) {
        super(circles);
    }
     ...
     */
    public PROMedSRobustLateration2DSolver(double[] qualityScores) {
        super();
        ...
        PROMedSRobustEstimator<Point2D> innerEstimator =
                new PROMedSRobustEstimator<>(new PROMedSRobustEstimatorListener<Point2D>() {
                    ...
                    public void onEstimateStart(RobustEstimator<Point2D> estimator) {
                        if (mListener != null) {
                            mListener.onSolveStart(PROMedSRobustLateration2DSolver.this);
                        }
                    }
                    ...
                    public void onEstimateEnd(RobustEstimator<Point2D> estimator) {
                        if (mListener != null) {
                            mListener.onSolveEnd(PROMedSRobustLateration2DSolver.this);
                        }
                    }
                    ...
                    public void onEstimateNextIteration(RobustEstimator<Point2D> estimator, int iteration) {
                        if (mListener != null) {
                            mListener.onSolveNextIteration(PROMedSRobustLateration2DSolver.this,
                                    iteration);
                        }
                    }
                    ...
                    public void onEstimateProgressChange(RobustEstimator<Point2D> estimator, float progress) {
                        if (mListener != null) {
                            mListener.onSolveProgressChange(PROMedSRobustLateration2DSolver.this,
                                    progress);
                        }
                    }
                });
