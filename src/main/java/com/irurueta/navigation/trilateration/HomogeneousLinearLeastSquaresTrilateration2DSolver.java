...
public class HomogeneousLinearLeastSquaresTrilateration2DSolver extends
        HomogeneousLinearLeastSquaresTrilaterationSolver<Point2D> {

    /**
     * Constructor.
     */
    public HomogeneousLinearLeastSquaresTrilateration2DSolver() {
        super();
    }
     ...
     */
    public HomogeneousLinearLeastSquaresTrilateration2DSolver(Point2D[] positions, double[] distances) {
     ...
     */
    public HomogeneousLinearLeastSquaresTrilateration2DSolver(TrilaterationSolverListener<Point2D> listener) {
        super(listener);
    }
     ...
     */
    public HomogeneousLinearLeastSquaresTrilateration2DSolver(Circle[] circles) {
        super();
