...
public abstract class HomogeneousLinearLeastSquaresTrilaterationSolver<P extends Point> extends
        TrilaterationSolver<P> {

    /**
     * Constructor.
     */
    public HomogeneousLinearLeastSquaresTrilaterationSolver() {
        super();
    }
     ...
     */
    public HomogeneousLinearLeastSquaresTrilaterationSolver(P[] positions, double[] distances) {
     ...
     */
    public HomogeneousLinearLeastSquaresTrilaterationSolver(TrilaterationSolverListener<P> listener) {
        super(listener);
    }
    ...
    public void solve() throws TrilaterationException, NotReadyException,
        ...
        try {
            ...
            if (nullity > 1) {
                ...
                // points
                throw new TrilaterationException();
            }
    ...
    public TrilaterationSolverType getType() {
        return TrilaterationSolverType.HOMOGENEOUS_LINEAR_TRILATERATION_SOLVER;
    }
}
