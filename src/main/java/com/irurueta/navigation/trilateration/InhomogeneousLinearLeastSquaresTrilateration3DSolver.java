...
public class InhomogeneousLinearLeastSquaresTrilateration3DSolver extends
        InhomogeneousLinearLeastSquaresTrilaterationSolver<Point3D> {

    /**
     * Constructor.
     */
    public InhomogeneousLinearLeastSquaresTrilateration3DSolver() {
        super();
    }
     ...
     */
    public InhomogeneousLinearLeastSquaresTrilateration3DSolver(Point3D[] positions, double[] distances) {
     ...
     */
    public InhomogeneousLinearLeastSquaresTrilateration3DSolver(TrilaterationSolverListener<Point3D> listener) {
        super(listener);
    }
     ...
     */
    public InhomogeneousLinearLeastSquaresTrilateration3DSolver(Sphere[] spheres) {
        super();
