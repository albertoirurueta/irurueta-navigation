...
public class LMedSRobustTrilateration3DSolver extends RobustTrilateration3DSolver {
     ...
     * Constructor.
     */
    public LMedSRobustTrilateration3DSolver() {
        super();
    }
     ...
     */
    public LMedSRobustTrilateration3DSolver(RobustTrilaterationSolverListener<Point3D> listener) {
        super(listener);
    }
     ...
     */
    public LMedSRobustTrilateration3DSolver(Point3D[] positions, double[] distances) {
     ...
     */
    public LMedSRobustTrilateration3DSolver(Sphere[] spheres) {
        super(spheres);
    }
        ...
        LMedSRobustEstimator<Point3D> innerEstimator =
                new LMedSRobustEstimator<>(new LMedSRobustEstimatorListener<Point3D>() {
                    ...
                    public boolean isReady() {
                        return LMedSRobustTrilateration3DSolver.this.isReady();
                    }

                    @Override
                    public void onEstimateStart(RobustEstimator<Point3D> estimator) {
                        if (mListener != null) {
                            mListener.onSolveStart(LMedSRobustTrilateration3DSolver.this);
                        }
                    }
                    ...
                    public void onEstimateEnd(RobustEstimator<Point3D> estimator) {
                        if (mListener != null) {
                            mListener.onSolveEnd(LMedSRobustTrilateration3DSolver.this);
                        }
                    }
                    ...
                    public void onEstimateNextIteration(RobustEstimator<Point3D> estimator, int iteration) {
                        if (mListener != null) {
                            mListener.onSolveNextIteration(LMedSRobustTrilateration3DSolver.this,
                                    iteration);
                        }
                    }
                    ...
                    public void onEstimateProgressChange(RobustEstimator<Point3D> estimator, float progress) {
                        if (mListener != null) {
                            mListener.onSolveProgressChange(LMedSRobustTrilateration3DSolver.this, progress);
                        }
                    }
                });
