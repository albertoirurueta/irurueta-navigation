...
public class RANSACRobustTrilateration3DSolver extends RobustTrilateration3DSolver {
     ...
     * Constructor.
     */
    public RANSACRobustTrilateration3DSolver() {
        super();
    }
        ...
        RANSACRobustEstimator<Point3D> innerEstimator =
                new RANSACRobustEstimator<>(new RANSACRobustEstimatorListener<Point3D>() {
                    ...
                    public boolean isReady() {
                        return RANSACRobustTrilateration3DSolver.this.isReady();
                    }

                    @Override
                    public void onEstimateStart(RobustEstimator<Point3D> estimator) {
                        if (mListener != null) {
                            mListener.onSolveStart(RANSACRobustTrilateration3DSolver.this);
                        }
                    }
                    ...
                    public void onEstimateEnd(RobustEstimator<Point3D> estimator) {
                        if (mListener != null) {
                            mListener.onSolveEnd(RANSACRobustTrilateration3DSolver.this);
                        }
                    }
                    ...
                    public void onEstimateNextIteration(RobustEstimator<Point3D> estimator, int iteration) {
                        if (mListener != null) {
                            mListener.onSolveNextIteration(RANSACRobustTrilateration3DSolver.this,
                                    iteration);
                        }
                    }
                    ...
                    public void onEstimateProgressChange(RobustEstimator<Point3D> estimator, float progress) {
                        if (mListener != null) {
                            mListener.onSolveProgressChange(RANSACRobustTrilateration3DSolver.this,
                                    progress);
                        }
                    }
                });
