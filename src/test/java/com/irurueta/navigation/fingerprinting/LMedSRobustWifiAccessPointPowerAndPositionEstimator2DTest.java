...
public class LMedSRobustWifiAccessPointPowerAndPositionEstimator2DTest implements
        RobustWifiAccessPointPowerAndPositionEstimatorListener<Point2D> {

    private static final Logger LOGGER = Logger.getLogger(
            LMedSRobustWifiAccessPointPowerAndPositionEstimator2DTest.class.getName());
    ...
    public LMedSRobustWifiAccessPointPowerAndPositionEstimator2DTest() { }
    ...
    public void testConstructor() {
        ...
        LMedSRobustWifiAccessPointPowerAndPositionEstimator2D estimator =
                new LMedSRobustWifiAccessPointPowerAndPositionEstimator2D();

        //check
        assertEquals(estimator.getStopThreshold(),
                LMedSRobustWifiAccessPointPowerAndPositionEstimator2D.DEFAULT_STOP_THRESHOLD,
                0.0);
        ...
        estimator = new LMedSRobustWifiAccessPointPowerAndPositionEstimator2D(this);
    ...
    public void onEstimateStart(RobustWifiAccessPointPowerAndPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((LMedSRobustWifiAccessPointPowerAndPositionEstimator2D)estimator);
    }
    ...
    @Override
    public void onEstimateNextIteration(RobustWifiAccessPointPowerAndPositionEstimator<Point2D> estimator, int iteration) {
        estimateNextIteration++;
        checkLocked((LMedSRobustWifiAccessPointPowerAndPositionEstimator2D)estimator);
    }

    @Override
    public void onEstimateProgressChange(RobustWifiAccessPointPowerAndPositionEstimator<Point2D> estimator, float progress) {
    ...
    private void checkLocked(LMedSRobustWifiAccessPointPowerAndPositionEstimator2D estimator) {
        try {
            estimator.setStopThreshold(0.5);
