...
public class LMedSRobustWifiAccessPointPowerAndPositionEstimator3DTest implements
        RobustWifiAccessPointPowerAndPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            LMedSRobustWifiAccessPointPowerAndPositionEstimator3DTest.class.getName());
    ...
    public LMedSRobustWifiAccessPointPowerAndPositionEstimator3DTest() { }
    ...
    public void testConstructor() {
        ...
        LMedSRobustWifiAccessPointPowerAndPositionEstimator3D estimator =
                new LMedSRobustWifiAccessPointPowerAndPositionEstimator3D();

        //check
        assertEquals(estimator.getStopThreshold(),
                LMedSRobustWifiAccessPointPowerAndPositionEstimator3D.DEFAULT_STOP_THRESHOLD,
                0.0);
        ...
        estimator = new LMedSRobustWifiAccessPointPowerAndPositionEstimator3D(
                readings);
        ...
        estimator = new LMedSRobustWifiAccessPointPowerAndPositionEstimator3D(this);
    ...
    public void onEstimateStart(RobustWifiAccessPointPowerAndPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((LMedSRobustWifiAccessPointPowerAndPositionEstimator3D)estimator);
    }
    ...
    @Override
    public void onEstimateNextIteration(RobustWifiAccessPointPowerAndPositionEstimator<Point3D> estimator, int iteration) {
        estimateNextIteration++;
        checkLocked((LMedSRobustWifiAccessPointPowerAndPositionEstimator3D)estimator);
    }

    @Override
    public void onEstimateProgressChange(RobustWifiAccessPointPowerAndPositionEstimator<Point3D> estimator, float progress) {
    ...
    private void checkLocked(LMedSRobustWifiAccessPointPowerAndPositionEstimator3D estimator) {
        try {
            estimator.setStopThreshold(0.5);
