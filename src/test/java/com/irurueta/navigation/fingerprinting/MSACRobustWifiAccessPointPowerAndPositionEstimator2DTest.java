...
public class MSACRobustWifiAccessPointPowerAndPositionEstimator2DTest implements
        RobustWifiAccessPointPowerAndPositionEstimatorListener<Point2D> {

    private static final Logger LOGGER = Logger.getLogger(
            MSACRobustWifiAccessPointPowerAndPositionEstimator2DTest.class.getName());
    ...
    public MSACRobustWifiAccessPointPowerAndPositionEstimator2DTest() { }
    ...
    public void testConstructor() {
        ...
        MSACRobustWifiAccessPointPowerAndPositionEstimator2D estimator =
                new MSACRobustWifiAccessPointPowerAndPositionEstimator2D();

        //check
        assertEquals(estimator.getThreshold(),
                MSACRobustWifiAccessPointPowerAndPositionEstimator2D.DEFAULT_THRESHOLD,
                0.0);
        ...
        estimator = new MSACRobustWifiAccessPointPowerAndPositionEstimator2D(this);
    ...
    public void onEstimateStart(RobustWifiAccessPointPowerAndPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((MSACRobustWifiAccessPointPowerAndPositionEstimator2D)estimator);
    }
    ...
    private void checkLocked(MSACRobustWifiAccessPointPowerAndPositionEstimator2D estimator) {
        try {
            estimator.setThreshold(0.5);
