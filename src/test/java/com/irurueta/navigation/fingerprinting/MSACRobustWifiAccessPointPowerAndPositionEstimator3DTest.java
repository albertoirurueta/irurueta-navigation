...
public class MSACRobustWifiAccessPointPowerAndPositionEstimator3DTest implements
        RobustWifiAccessPointPowerAndPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            MSACRobustWifiAccessPointPowerAndPositionEstimator3DTest.class.getName());
    ...
    public MSACRobustWifiAccessPointPowerAndPositionEstimator3DTest() { }
    ...
    public void testConstructor() {
        ...
        MSACRobustWifiAccessPointPowerAndPositionEstimator3D estimator =
                new MSACRobustWifiAccessPointPowerAndPositionEstimator3D();

        //check
        assertEquals(estimator.getThreshold(),
                MSACRobustWifiAccessPointPowerAndPositionEstimator3D.DEFAULT_THRESHOLD,
                0.0);
        ...
        estimator = new MSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                readings);
        ...
        estimator = new MSACRobustWifiAccessPointPowerAndPositionEstimator3D(this);
    ...
    public void onEstimateStart(RobustWifiAccessPointPowerAndPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((MSACRobustWifiAccessPointPowerAndPositionEstimator3D)estimator);
    }
    ...
    private void checkLocked(MSACRobustWifiAccessPointPowerAndPositionEstimator3D estimator) {
        try {
            estimator.setThreshold(0.5);
