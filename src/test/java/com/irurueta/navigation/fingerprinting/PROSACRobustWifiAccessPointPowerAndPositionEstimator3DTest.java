...
public class PROSACRobustWifiAccessPointPowerAndPositionEstimator3DTest implements
        RobustWifiAccessPointPowerAndPositionEstimatorListener<Point3D>{

    private static final Logger LOGGER = Logger.getLogger(
            PROSACRobustWifiAccessPointPowerAndPositionEstimator3DTest.class.getName());
    ...
    public PROSACRobustWifiAccessPointPowerAndPositionEstimator3DTest() { }
    ...
    public void testConstructor() {
        ...
        PROSACRobustWifiAccessPointPowerAndPositionEstimator3D estimator =
                new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D();

        //check
        assertEquals(estimator.getThreshold(), PROSACRobustWifiAccessPointPowerAndPositionEstimator3D.DEFAULT_THRESHOLD,
                0.0);
        assertEquals(estimator.isComputeAndKeepInliersEnabled(),
                PROSACRobustWifiAccessPointPowerAndPositionEstimator3D.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertEquals(estimator.isComputeAndKeepResidualsEnabled(),
                PROSACRobustWifiAccessPointPowerAndPositionEstimator3D.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
        ...
        estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                readings);
        ...
        estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(this);
        ...
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                    (List<WifiRssiReadingLocated3D<WifiAccessPoint>>)null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
        ...
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                    (List<WifiRssiReadingLocated3D<WifiAccessPoint>>)null, initialPosition, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
        ...
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                    (List<WifiRssiReadingLocated3D<WifiAccessPoint>>)null, initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
        ...
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                    (List<WifiRssiReadingLocated3D<WifiAccessPoint>>)null, initialPosition, MAX_RSSI, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
        ...
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                    qualityScores, (List<WifiRssiReadingLocated3D<WifiAccessPoint>>)null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                    qualityScores, new ArrayList<WifiRssiReadingLocated3D<WifiAccessPoint>>());
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(estimator);
        ...
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                    qualityScores, (List<WifiRssiReadingLocated3D<WifiAccessPoint>>)null, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                    qualityScores, new ArrayList<WifiRssiReadingLocated3D<WifiAccessPoint>>(), this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(estimator);
        ...
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                    qualityScores, (List<WifiRssiReadingLocated3D<WifiAccessPoint>>)null, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                    qualityScores, new ArrayList<WifiRssiReadingLocated3D<WifiAccessPoint>>(), MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(estimator);
        ...
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                    qualityScores, (List<WifiRssiReadingLocated3D<WifiAccessPoint>>)null, MAX_RSSI, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                    qualityScores, new ArrayList<WifiRssiReadingLocated3D<WifiAccessPoint>>(), MAX_RSSI, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(estimator);
        ...
        try {
            estimator = new PROSACRobustWifiAccessPointPowerAndPositionEstimator3D(
                    qualityScores, new ArrayList<WifiRssiReadingLocated3D<WifiAccessPoint>>(), initialPosition,
                    MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(estimator);
    ...
    public void testGetSetThreshold() throws LockedException {
        ...
        assertEquals(estimator.getThreshold(),
                PROSACRobustWifiAccessPointPowerAndPositionEstimator3D.DEFAULT_THRESHOLD,
                0.0);
    ...
    public void onEstimateStart(RobustWifiAccessPointPowerAndPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((PROSACRobustWifiAccessPointPowerAndPositionEstimator3D)estimator);
    }
    ...
    private void checkLocked(PROSACRobustWifiAccessPointPowerAndPositionEstimator3D estimator) {
        try {
