...
public class UtilsTest {
    ...
    public void testPropagateVariancesToDistanceVariance()
            throws FingerprintingException, EvaluationException {
        UniformRandomizer randomizer = new UniformRandomizer(new Random());
    ...
    @Test
    public void testPropagateTxPowerVarianceToDistanceVariance() throws FingerprintingException {
        UniformRandomizer randomizer = new UniformRandomizer(new Random());
    ...
    @Test
    public void testPropagateRxPowerVarianceToDistanceVariance() throws FingerprintingException {
        UniformRandomizer randomizer = new UniformRandomizer(new Random());
    ...
    @Test
    public void testPropagatePathlossExponentVarianceToDistanceVariance() throws FingerprintingException {
        UniformRandomizer randomizer = new UniformRandomizer(new Random());
    ...
    @Test
    public void testPropagateNoVarianceToDistanceVariance() throws FingerprintingException {
        UniformRandomizer randomizer = new UniformRandomizer(new Random());
