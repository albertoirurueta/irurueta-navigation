...
public class WifiAccessPointLocated3DTest {
    ...
    public void testEquals() {
        ...
        InhomogeneousPoint3D position = new InhomogeneousPoint3D(
                ...
                randomizer.nextDouble(MIN_POS, MAX_POS),
                randomizer.nextDouble(MIN_POS, MAX_POS));
        WifiAccessPointLocated3D ap1 = new WifiAccessPointLocated3D("bssid1",
                FREQUENCY, position);
        WifiAccessPointLocated3D ap2 = new WifiAccessPointLocated3D("bssid1",
                FREQUENCY, position);
        WifiAccessPointLocated3D ap3 = new WifiAccessPointLocated3D("bssid2",
                FREQUENCY, position);
