...
public class PROMedSRobustRangingAndRssiRadioSourceEstimator3DTest implements
    ...
    public PROMedSRobustRangingAndRssiRadioSourceEstimator3DTest() { }
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            PROMedSRobustRangingAndRssiRadioSourceEstimator3D<Beacon> estimator =
                    new PROMedSRobustRangingAndRssiRadioSourceEstimator3D<>(
                            qualityScores, readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    @Override
    public void onEstimateNextIteration(RobustRangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point3D> estimator, int iteration) {
        estimateNextIteration++;
        checkLocked((PROMedSRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint>)estimator);
    }

    @Override
    public void onEstimateProgressChange(RobustRangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point3D> estimator, float progress) {
    ...
    private void checkLocked(PROMedSRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint> estimator) {
        try {
            estimator.setPathLossEstimationEnabled(false);
