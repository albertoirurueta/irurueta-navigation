...
public class FirstOrderNonLinearFingerprintPositionEstimator2DTest
    ...
    public FirstOrderNonLinearFingerprintPositionEstimator2DTest() { }
    ...
    public void testEstimateWithoutErrorWithoutBiasAndWithoutInitialPosition()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            FirstOrderNonLinearFingerprintPositionEstimator2D estimator = new FirstOrderNonLinearFingerprintPositionEstimator2D(
    ...
    private void checkLocked(FirstOrderNonLinearFingerprintPositionEstimator2D estimator) {
        try {
            estimator.setLocatedFingerprints(null);
