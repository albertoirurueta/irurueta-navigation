...
public class LMedSRobustPositionEstimator3DTest implements
        RobustPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            LMedSRobustPositionEstimator3DTest.class.getName());
    ...
    public void testConstructor() {
        // empty constructor
        LMedSRobustPositionEstimator3D estimator =
                new LMedSRobustPositionEstimator3D();
        ...
        estimator = new LMedSRobustPositionEstimator3D(sources);
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustPositionEstimator3D(
        ...
        RssiFingerprint<WifiAccessPoint, RssiReading<WifiAccessPoint>> fingerprint =
                new RssiFingerprint<>();
        estimator = new LMedSRobustPositionEstimator3D(fingerprint);
        ...
        estimator = new LMedSRobustPositionEstimator3D(sources, fingerprint);
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustPositionEstimator3D(null, fingerprint);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            estimator = new LMedSRobustPositionEstimator3D(
        ...
        estimator = new LMedSRobustPositionEstimator3D(this);
        ...
        estimator = new LMedSRobustPositionEstimator3D(sources, this);
        ...
        estimator = new LMedSRobustPositionEstimator3D(fingerprint, this);
    ...
    public void testGetSetInitialPosition() throws LockedException {
        LMedSRobustPositionEstimator3D solver =
                new LMedSRobustPositionEstimator3D();
    ...
    public void testEstimateRssi() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            LMedSRobustPositionEstimator3D estimator =
                    new LMedSRobustPositionEstimator3D(sources, fingerprint,
                            this);
    ...
    @Test
    public void testEstimateMixedLinearDisabled() throws LockedException, NotReadyException,
            RobustEstimatorException, AlgebraException {
        UniformRandomizer randomizer = new UniformRandomizer(new Random());
        GaussianRandomizer errorRandomizer = new GaussianRandomizer(
                new Random(), 0.0, STD_OUTLIER_ERROR);
    ...
    public void onEstimateStart(RobustPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((LMedSRobustPositionEstimator3D)estimator);
    }
    ...
    private double receivedPower(double equivalentTransmittedPower,
        ...
        double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI * LMedSRobustPositionEstimator3DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k /
                Math.pow(distance, pathLossExponent);
    }

    private void checkLocked(LMedSRobustPositionEstimator3D estimator) {
        try {
            estimator.setRadioSourcePositionCovarianceUsed(true);
