...
public class FirstOrderNonLinearSourcedRssiPositionEstimator2DTest
        implements SourcedRssiPositionEstimatorListener<Point2D> {

    private static final Logger LOGGER = Logger.getLogger(
            SecondOrderNonLinearSourcedRssiPositionEstimator2DTest.class.getName());
    ...
    public FirstOrderNonLinearSourcedRssiPositionEstimator2DTest() { }
    ...
    public void testConstructor() {
        ...
        FirstOrderNonLinearSourcedRssiPositionEstimator2D estimator =
                new FirstOrderNonLinearSourcedRssiPositionEstimator2D();
        ...
        assertEquals(estimator.getType(), NonLinearSourcedRssiPositionEstimatorType.FIRST_ORDER);


        //test constructor with listener
        estimator = new FirstOrderNonLinearSourcedRssiPositionEstimator2D(this);
        ...
        estimator = new FirstOrderNonLinearSourcedRssiPositionEstimator2D(locatedFingerprints,
                fingerprint, sources);
        ...
        estimator = null;
        try {
            estimator = new FirstOrderNonLinearSourcedRssiPositionEstimator2D(
                    new ArrayList<RssiFingerprintLocated2D<RadioSource,
                    RssiReading<RadioSource>>>(), fingerprint, sources);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            estimator = new FirstOrderNonLinearSourcedRssiPositionEstimator2D(null,
                    fingerprint, sources);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
    ...
    public void testEstimateWithoutErrorWithoutBiasAndWithoutInitialPosition()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            for (int j = 0; j < numFingerprints; j++) {
                ...
                for (RadioSourceLocated<Point2D> source : sources) {
                    ...
                    double receivedRssi = Utils.powerTodBm(receivedPower(Utils.dBmToPower(transmittedPowerdBm),
                            distance, LinearSourcedRssiPositionEstimator2D.DEFAULT_PATH_LOSS_EXPONENT));
            ...
            for (RadioSourceLocated<Point2D> source : sources) {
                ...
                double receivedRssi = Utils.powerTodBm(receivedPower(Utils.dBmToPower(transmittedPowerdBm), distance,
                        LinearSourcedRssiPositionEstimator2D.DEFAULT_PATH_LOSS_EXPONENT));
                RssiReading<RadioSource> reading = new RssiReading<>((RadioSource) source,
                        receivedRssi);
                readings.add(reading);
            }
            ...
            FirstOrderNonLinearSourcedRssiPositionEstimator2D estimator = new FirstOrderNonLinearSourcedRssiPositionEstimator2D(
        ...
        LOGGER.log(Level.INFO,
                "Avg. Estimated position with means removed only on finder error: {0} m, accuracy: {1} with {2}% confidence",
                new Object[]{avgNoMeanFinderEstimatedError, avgNoMeanFinderEstimatedAccuracy,
                        accuracy.getConfidence() * 100.0});
        LOGGER.log(Level.INFO,
                "Avg. Estimated position with means removed only on readings error: {0} m, accuracy: {1} with {2}% confidence",
                new Object[]{avgNoMeanReadingsEstimatedError, avgNoMeanReadingsEstimatedAccuracy,
                        accuracy.getConfidence() * 100.0});
        LOGGER.log(Level.INFO,
                "Avg. Estimated position with means not removed error: {0} m, accuracy: {1} with {2}% confidence",
    ...
    public void testEstimateWithoutErrorWithoutBiasAndWithInitialPosition()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            //create estimator with means removed on finder and fingerprints
            LinearSourcedRssiPositionEstimator2D linearEstimator = new LinearSourcedRssiPositionEstimator2D(
            ...
            FirstOrderNonLinearSourcedRssiPositionEstimator2D nonLinearEstimator =
                    new FirstOrderNonLinearSourcedRssiPositionEstimator2D(
            ...
            //create estimator with means removed only on finder
            linearEstimator = new LinearSourcedRssiPositionEstimator2D(
                    locatedFingerprints, fingerprint, sources);
            linearEstimator.setUseNoMeanNearestFingerprintFinder(true);
            ...
            nonLinearEstimator = new FirstOrderNonLinearSourcedRssiPositionEstimator2D(
                    locatedFingerprints, fingerprint, sources, initialPosition,
                    this);
            nonLinearEstimator.setUseNoMeanNearestFingerprintFinder(true);
    ...
    public void testEstimateCompareInitialPosition()
        ...
        LOGGER.log(Level.INFO,
                ...
                new Object[]{avgEstimatedErrorWithoutInitialPosition,
                        ...
                        accuracy.getConfidence() * 100.0});
        LOGGER.log(Level.INFO,
                "Avg. error with initial position: {0} m, accuracy: {1} with {2}% confidence",
                new Object[]{avgEstimatedErrorWithInitialPosition,
                        avgAccuracyWithInitialPosition,
                        accuracy.getConfidence() * 100.0});
        LOGGER.log(Level.INFO,
                "Avg. error with exact initial position: {0} m, accuracy: {1} with {2}% confidence",
    ...
    public void onEstimateStart(SourcedRssiPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((FirstOrderNonLinearSourcedRssiPositionEstimator2D)estimator);
    }
    ...
    private void checkLocked(FirstOrderNonLinearSourcedRssiPositionEstimator2D estimator) {
        try {
            estimator.setLocatedFingerprints(null);
