...
public class LMedSRobustPositionEstimator2DTest implements
    ...
    public void testGetSetInitialPosition() throws LockedException {
        LMedSRobustPositionEstimator2D solver =
                new LMedSRobustPositionEstimator2D();
    ...
    @Test
    public void testEstimateMixedPreliminaryNotRefined()
            throws LockedException, NotReadyException, RobustEstimatorException,
            NonSymmetricPositiveDefiniteMatrixException {
        UniformRandomizer randomizer = new UniformRandomizer(new Random());
        GaussianRandomizer errorRandomizer = new GaussianRandomizer(
    ...
    @Test
    public void testEstimateMixedLinearDisabled()
            throws LockedException, NotReadyException, RobustEstimatorException,
            NonSymmetricPositiveDefiniteMatrixException {
        UniformRandomizer randomizer = new UniformRandomizer(new Random());
        GaussianRandomizer errorRandomizer = new GaussianRandomizer(
    ...
    private double receivedPower(double equivalentTransmittedPower,
        ...
        double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI * LMedSRobustPositionEstimator2DTest.FREQUENCY),
                pathLossExponent);
