...
public class LMedSRobustRangingAndRssiPositionEstimator2DTest implements
    ...
    public void testGetSetInitialPosition() throws LockedException {
        LMedSRobustRangingAndRssiPositionEstimator2D solver =
                new LMedSRobustRangingAndRssiPositionEstimator2D();
    ...
    @Override
    public void onEstimateStart(RobustRangingAndRssiPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((LMedSRobustRangingAndRssiPositionEstimator2D) estimator);
    }

    @Override
    public void onEstimateEnd(RobustRangingAndRssiPositionEstimator<Point2D> estimator) {
        estimateEnd++;
        checkLocked((LMedSRobustRangingAndRssiPositionEstimator2D) estimator);
    }
    ...
    private void checkLocked(LMedSRobustRangingAndRssiPositionEstimator2D estimator) {
        try {
