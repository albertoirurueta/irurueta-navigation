...
public class LMedSRobustRangingAndRssiPositionEstimator3DTest implements
    ...
    public void testGetSetInitialPosition() throws LockedException {
        LMedSRobustRangingAndRssiPositionEstimator3D solver =
                new LMedSRobustRangingAndRssiPositionEstimator3D();
    ...
    @Override
    public void onEstimateStart(RobustRangingAndRssiPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((LMedSRobustRangingAndRssiPositionEstimator3D) estimator);
    }

    @Override
    public void onEstimateEnd(RobustRangingAndRssiPositionEstimator<Point3D> estimator) {
        estimateEnd++;
        checkLocked((LMedSRobustRangingAndRssiPositionEstimator3D) estimator);
    }
    ...
    private void checkLocked(LMedSRobustRangingAndRssiPositionEstimator3D estimator) {
        try {
