...
public class LMedSRobustRssiPositionEstimator3DTest implements
    ...
    public void testGetSetInitialPosition() throws LockedException {
        LMedSRobustRssiPositionEstimator3D solver =
                new LMedSRobustRssiPositionEstimator3D();
    ...
    private double receivedPower(double equivalentTransmittedPower,
        ...
        double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI * LMedSRobustRssiPositionEstimator3DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k /
                Math.pow(distance, pathLossExponent);
    }

    private void checkLocked(LMedSRobustRssiPositionEstimator3D estimator) {
        try {
