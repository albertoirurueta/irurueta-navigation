...
public class MSACRobustRssiPositionEstimator2DTest implements
    ...
    public void testGetSetInitialPosition() throws LockedException {
        MSACRobustRssiPositionEstimator2D solver =
                new MSACRobustRssiPositionEstimator2D();
    ...
    private double receivedPower(double equivalentTransmittedPower,
        ...
        double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI * MSACRobustRssiPositionEstimator2DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k /
                Math.pow(distance, pathLossExponent);
    }

    private void checkLocked(MSACRobustRssiPositionEstimator2D estimator) {
        try {
