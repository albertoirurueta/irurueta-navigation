...
public class MSACRobustRssiPositionEstimator3DTest implements
    ...
    public void testGetSetInitialPosition() throws LockedException {
        MSACRobustRssiPositionEstimator3D solver =
                new MSACRobustRssiPositionEstimator3D();
    ...
    @Override
    public void onEstimateNextIteration(RobustRssiPositionEstimator<Point3D> estimator, int iteration) {
        estimateNextIteration++;
        checkLocked((MSACRobustRssiPositionEstimator3D) estimator);
    }

    @Override
    public void onEstimateProgressChange(RobustRssiPositionEstimator<Point3D> estimator, float progress) {
    ...
    private double receivedPower(double equivalentTransmittedPower,
        ...
        double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI * MSACRobustRssiPositionEstimator3DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k /
                Math.pow(distance, pathLossExponent);
    }

    private void checkLocked(MSACRobustRssiPositionEstimator3D estimator) {
        try {
