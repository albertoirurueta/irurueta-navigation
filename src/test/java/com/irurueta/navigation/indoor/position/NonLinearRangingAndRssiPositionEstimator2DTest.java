...
public class NonLinearRangingAndRssiPositionEstimator2DTest implements
    ...
    @Override
    public void onEstimateStart(RangingAndRssiPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((NonLinearRangingAndRssiPositionEstimator2D) estimator);
    }

    @Override
    public void onEstimateEnd(RangingAndRssiPositionEstimator<Point2D> estimator) {
        estimateEnd++;
        checkLocked((NonLinearRangingAndRssiPositionEstimator2D) estimator);
    }
    ...
    private void checkLocked(NonLinearRangingAndRssiPositionEstimator2D estimator) {
        try {
