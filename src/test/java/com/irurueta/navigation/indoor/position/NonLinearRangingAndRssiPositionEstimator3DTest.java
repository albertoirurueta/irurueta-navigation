...
public class NonLinearRangingAndRssiPositionEstimator3DTest implements
    ...
    @Override
    public void onEstimateStart(RangingAndRssiPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((NonLinearRangingAndRssiPositionEstimator3D) estimator);
    }

    @Override
    public void onEstimateEnd(RangingAndRssiPositionEstimator<Point3D> estimator) {
        estimateEnd++;
        checkLocked((NonLinearRangingAndRssiPositionEstimator3D) estimator);
    }
    ...
    private void checkLocked(NonLinearRangingAndRssiPositionEstimator3D estimator) {
        try {
