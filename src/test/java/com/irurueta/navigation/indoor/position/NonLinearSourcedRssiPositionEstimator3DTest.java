...
public class NonLinearSourcedRssiPositionEstimator3DTest
    ...
    public void testCreate() {
        ...
        //first order
        NonLinearSourcedRssiPositionEstimator3D estimator =
                NonLinearSourcedRssiPositionEstimator3D.create(
        ...
        //second order
        estimator = NonLinearSourcedRssiPositionEstimator3D.create(
        ...
        //first order
        estimator = NonLinearSourcedRssiPositionEstimator3D.create(this,
                NonLinearSourcedRssiPositionEstimatorType.FIRST_ORDER);
        ...
        //first order
        estimator = NonLinearSourcedRssiPositionEstimator3D.create(locatedFingerprints,
    ...
    public void testEstimateOrderComparison() throws EvaluationException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            RadioSourceNoMeanKNearestFinder<Point3D, RadioSource> fingerprintFinder =
            ...
            NonLinearSourcedRssiPositionEstimator3D firstOrderEstimator =
                    NonLinearSourcedRssiPositionEstimator3D.create(
                            locatedFingerprints, fingerprint, sources, this,
                            NonLinearSourcedRssiPositionEstimatorType.FIRST_ORDER);
            NonLinearSourcedRssiPositionEstimator3D secondOrderEstimator =
                    NonLinearSourcedRssiPositionEstimator3D.create(
                            locatedFingerprints, fingerprint, sources, this,
                            NonLinearSourcedRssiPositionEstimatorType.SECOND_ORDER);
            NonLinearSourcedRssiPositionEstimator3D thirdOrderEstimator =
                    NonLinearSourcedRssiPositionEstimator3D.create(
                            locatedFingerprints, fingerprint, sources, this,
                            NonLinearSourcedRssiPositionEstimatorType.THIRD_ORDER);
            ...
            for (int i = 0; i < numSources; i++) {
                RadioSourceLocated<Point3D> source = sources.get(i);
                ...
                point[7] = LinearSourcedRssiPositionEstimator3D.DEFAULT_PATH_LOSS_EXPONENT;
                ...
                Point3D estimatedPositionFirstOrder = firstOrderEstimator.
                        getEstimatedPosition();
                Point3D estimatedPositionSecondOrder = secondOrderEstimator.
                        getEstimatedPosition();
                Point3D estimatedPositionThirdOrder = thirdOrderEstimator.
                        getEstimatedPosition();
