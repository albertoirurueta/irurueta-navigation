...
public class RANSACRobustPositionEstimator3DTest implements
        RobustPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            RANSACRobustPositionEstimator3DTest.class.getName());
    ...
    public void testConstructor() {
        //empty constructor
        RANSACRobustPositionEstimator3D estimator =
                new RANSACRobustPositionEstimator3D();
        ...
        estimator = new RANSACRobustPositionEstimator3D(sources);
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustPositionEstimator3D(
        ...
        RssiFingerprint<WifiAccessPoint, RssiReading<WifiAccessPoint>> fingerprint =
                new RssiFingerprint<>();
        estimator = new RANSACRobustPositionEstimator3D(fingerprint);
        ...
        estimator = new RANSACRobustPositionEstimator3D(sources, fingerprint);
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustPositionEstimator3D(null, fingerprint);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            estimator = new RANSACRobustPositionEstimator3D(
        ...
        estimator = new RANSACRobustPositionEstimator3D(this);
        ...
        estimator = new RANSACRobustPositionEstimator3D(sources, this);
        ...
        estimator = new RANSACRobustPositionEstimator3D(fingerprint, this);
    ...
    public void testEstimateRssi() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            RANSACRobustPositionEstimator3D estimator =
                    new RANSACRobustPositionEstimator3D(sources, fingerprint,
                            this);
            estimator.setComputeAndKeepInliersEnabled(true);
            estimator.setComputeAndKeepResidualsEnabled(true);
    ...
    public void testEstimateRssiWithInlierError() throws LockedException, NotReadyException,
        ...
        avgValidPositionError /= numValidPosition;
        avgInvalidPositionError /= (num - numValidPosition);
        avgPositionError /= num;

        avgValidPositionStd /= numValidPosition;
        avgInvalidPositionStd /= (num - numValidPosition);
        avgPositionStd /= num;
        avgPositionStdConfidence /= num;

        avgValidPositionAccuracy /= numValidPosition;
        avgInvalidPositionAccuracy /= (num - numValidPosition);
        avgPositionAccuracy /= num;
        avgPositionAccuracyConfidence /= num;

        LOGGER.log(Level.INFO, "Percentage valid position: {0} %",
                (double)numValidPosition / (double)num * 100.0);
    ...
    public void onEstimateStart(RobustPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((RANSACRobustPositionEstimator3D)estimator);
    }
    ...
    private void checkLocked(RANSACRobustPositionEstimator3D estimator) {
        try {
            estimator.setRadioSourcePositionCovarianceUsed(true);
