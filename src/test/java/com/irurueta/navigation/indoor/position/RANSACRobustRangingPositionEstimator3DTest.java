...
public class RANSACRobustRangingPositionEstimator3DTest implements
    ...
    public void testGetSetInitialPosition() throws LockedException {
        RANSACRobustRangingPositionEstimator3D solver =
                new RANSACRobustRangingPositionEstimator3D();
    ...
    @Override
    public void onEstimateNextIteration(RobustRangingPositionEstimator<Point3D> estimator,
                                        int iteration) {
    ...
    @Override
    public void onEstimateProgressChange(RobustRangingPositionEstimator<Point3D> estimator,
                                         float progress) {
    ...
    private void checkLocked(RANSACRobustRangingPositionEstimator3D estimator) {
        try {
