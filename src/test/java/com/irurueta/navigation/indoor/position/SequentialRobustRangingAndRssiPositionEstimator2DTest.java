...
public class SequentialRobustRangingAndRssiPositionEstimator2DTest implements
    ...
    @Test
    public void testEstimateMultipleReadingsPerSourceWithInlierError() throws LockedException, NotReadyException, RobustEstimatorException, NonSymmetricPositiveDefiniteMatrixException {
        UniformRandomizer randomizer = new UniformRandomizer(new Random());
        GaussianRandomizer errorRandomizer = new GaussianRandomizer(
                new Random(), 0.0, STD_OUTLIER_ERROR);
        GaussianRandomizer inlierErrorRandomizer = new GaussianRandomizer(
    ...
    public void onEstimateStart(
            SequentialRobustRangingAndRssiPositionEstimator<Point2D> estimator) {
        estimateStart++;
    ...
    private void checkLocked(SequentialRobustRangingAndRssiPositionEstimator2D estimator) {
        try {
