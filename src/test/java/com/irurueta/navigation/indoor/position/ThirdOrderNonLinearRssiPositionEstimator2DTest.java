...
public class ThirdOrderNonLinearRssiPositionEstimator2DTest
        implements SourcedRssiPositionEstimatorListener<Point2D> {

    private static final Logger LOGGER = Logger.getLogger(
            ThirdOrderNonLinearRssiPositionEstimator2DTest.class.getName());
    ...
    public ThirdOrderNonLinearRssiPositionEstimator2DTest() { }
    ...
    public void testConstructor() {
        ...
        ThirdOrderNonLinearRssiPositionEstimator2D estimator =
                new ThirdOrderNonLinearRssiPositionEstimator2D();
        ...
        estimator = new ThirdOrderNonLinearRssiPositionEstimator2D(this);
        ...
        estimator = new ThirdOrderNonLinearRssiPositionEstimator2D(locatedFingerprints,
                fingerprint, sources);
        ...
        estimator = null;
        try {
            estimator = new ThirdOrderNonLinearRssiPositionEstimator2D(
    ...
    public void testEstimateWithoutErrorWithoutBiasAndWithInitialPosition()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            ThirdOrderNonLinearRssiPositionEstimator2D nonLinearEstimator =
                    new ThirdOrderNonLinearRssiPositionEstimator2D(
                            locatedFingerprints, fingerprint, sources, initialPosition,
                            this);
            ...
            nonLinearEstimator = new ThirdOrderNonLinearRssiPositionEstimator2D(
                    locatedFingerprints, fingerprint, sources, initialPosition,
                    this);
            nonLinearEstimator.setUseNoMeanNearestFingerprintFinder(true);
    ...
    public void onEstimateStart(RssiPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((ThirdOrderNonLinearRssiPositionEstimator2D)estimator);
    }
    ...
    private void checkLocked(ThirdOrderNonLinearRssiPositionEstimator2D estimator) {
        try {
            estimator.setLocatedFingerprints(null);
