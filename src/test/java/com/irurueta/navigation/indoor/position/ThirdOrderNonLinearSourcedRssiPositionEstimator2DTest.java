...
public class ThirdOrderNonLinearSourcedRssiPositionEstimator2DTest
        implements SourcedRssiPositionEstimatorListener<Point2D> {

    private static final Logger LOGGER = Logger.getLogger(
            ThirdOrderNonLinearSourcedRssiPositionEstimator2DTest.class.getName());
    ...
    public ThirdOrderNonLinearSourcedRssiPositionEstimator2DTest() { }
    ...
    public void testConstructor() {
        ...
        ThirdOrderNonLinearSourcedRssiPositionEstimator2D estimator =
                new ThirdOrderNonLinearSourcedRssiPositionEstimator2D();
        ...
        assertEquals(estimator.getType(), NonLinearSourcedRssiPositionEstimatorType.THIRD_ORDER);


        //test constructor with listener
        estimator = new ThirdOrderNonLinearSourcedRssiPositionEstimator2D(this);
        ...
        estimator = new ThirdOrderNonLinearSourcedRssiPositionEstimator2D(locatedFingerprints,
                fingerprint, sources);
        ...
        estimator = null;
        try {
            estimator = new ThirdOrderNonLinearSourcedRssiPositionEstimator2D(
    ...
    public void testEstimateWithoutErrorWithoutBiasAndWithInitialPosition()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            ThirdOrderNonLinearSourcedRssiPositionEstimator2D nonLinearEstimator =
                    new ThirdOrderNonLinearSourcedRssiPositionEstimator2D(
                            locatedFingerprints, fingerprint, sources, initialPosition,
                            this);
            ...
            nonLinearEstimator = new ThirdOrderNonLinearSourcedRssiPositionEstimator2D(
                    locatedFingerprints, fingerprint, sources, initialPosition,
                    this);
            nonLinearEstimator.setUseNoMeanNearestFingerprintFinder(true);
    ...
    public void onEstimateStart(SourcedRssiPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((ThirdOrderNonLinearSourcedRssiPositionEstimator2D)estimator);
    }
    ...
    private void checkLocked(ThirdOrderNonLinearSourcedRssiPositionEstimator2D estimator) {
        try {
            estimator.setLocatedFingerprints(null);
