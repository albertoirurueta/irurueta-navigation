...
public class ThirdOrderNonLinearSourcedRssiPositionEstimator3DTest
        implements SourcedRssiPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            ThirdOrderNonLinearSourcedRssiPositionEstimator3DTest.class.getName());
    ...
    public ThirdOrderNonLinearSourcedRssiPositionEstimator3DTest() { }
    ...
    public void testConstructor() {
        ...
        ThirdOrderNonLinearSourcedRssiPositionEstimator3D estimator =
                new ThirdOrderNonLinearSourcedRssiPositionEstimator3D();
        ...
        estimator = new ThirdOrderNonLinearSourcedRssiPositionEstimator3D(this);
        ...
        estimator = new ThirdOrderNonLinearSourcedRssiPositionEstimator3D(
    ...
    public void testEstimateWithoutErrorWithoutBiasAndWithInitialPosition()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            ThirdOrderNonLinearSourcedRssiPositionEstimator3D nonLinearEstimator =
                    new ThirdOrderNonLinearSourcedRssiPositionEstimator3D(
                            locatedFingerprints, fingerprint, sources, initialPosition,
                            this);
            ...
            nonLinearEstimator = new ThirdOrderNonLinearSourcedRssiPositionEstimator3D(
                    locatedFingerprints, fingerprint, sources, initialPosition,
                    this);
            nonLinearEstimator.setUseNoMeanNearestFingerprintFinder(true);
    ...
    public void onEstimateStart(SourcedRssiPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((ThirdOrderNonLinearSourcedRssiPositionEstimator3D)estimator);
    }
    ...
    private void checkLocked(ThirdOrderNonLinearSourcedRssiPositionEstimator3D estimator) {
        try {
            estimator.setLocatedFingerprints(null);
