...
public class MSACRobustRangingAndRssiRadioSourceEstimator2DTest implements
    ...
    public MSACRobustRangingAndRssiRadioSourceEstimator2DTest() { }
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            MSACRobustRangingAndRssiRadioSourceEstimator2D<Beacon> estimator =
                    new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(
                            readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private void checkLocked(MSACRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
        try {
            estimator.setPathLossEstimationEnabled(false);
