...
public class MSACRobustRangingAndRssiRadioSourceEstimator3DTest implements
    ...
    public MSACRobustRangingAndRssiRadioSourceEstimator3DTest() { }
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            MSACRobustRangingAndRssiRadioSourceEstimator3D<Beacon> estimator =
                    new MSACRobustRangingAndRssiRadioSourceEstimator3D<>(
                            readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private void checkLocked(MSACRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint> estimator) {
        try {
            estimator.setPathLossEstimationEnabled(false);
