...
public class MixedRadioSourceEstimator3DTest implements
    ...
    public void testEstimateBeacon() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            MixedRadioSourceEstimator3D<Beacon> estimator =
                    new MixedRadioSourceEstimator3D<>(readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    @Test
    public void testEstimateWithMixedRangingAndRssiReadingsAndHomogeneousRangingLinearSolver() throws LockedException,
    ...
    @Override
    public void onEstimateStart(MixedRadioSourceEstimator<WifiAccessPoint, Point3D> estimator) {
        estimateStart++;
        checkLocked(estimator);
    }

    @Override
    public void onEstimateEnd(MixedRadioSourceEstimator<WifiAccessPoint, Point3D> estimator) {
        estimateEnd++;
        checkLocked(estimator);
    }
    ...
    private void checkLocked(MixedRadioSourceEstimator<WifiAccessPoint, Point3D> estimator) {
        try {
