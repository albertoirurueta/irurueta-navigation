...
public class PROMedSRobustRangingAndRssiRadioSourceEstimator2DTest implements
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            PROMedSRobustRangingAndRssiRadioSourceEstimator2D<Beacon> estimator =
                    new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(
                            qualityScores, readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    @Override
    public void onEstimateNextIteration(RobustRangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator, int iteration) {
        estimateNextIteration++;
        checkLocked((PROMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint>)estimator);
    }

    @Override
    public void onEstimateProgressChange(RobustRangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator, float progress) {
    ...
    private void checkLocked(PROMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
        try {
            estimator.setPathLossEstimationEnabled(false);
