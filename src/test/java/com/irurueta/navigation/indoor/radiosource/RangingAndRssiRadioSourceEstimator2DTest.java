...
public class RangingAndRssiRadioSourceEstimator2DTest implements
    ...
    public RangingAndRssiRadioSourceEstimator2DTest() { }
    ...
    public void testEstimateBeacon() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            RangingAndRssiRadioSourceEstimator2D<Beacon> estimator =
                    new RangingAndRssiRadioSourceEstimator2D<>(readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void onEstimateStart(
            RangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        estimateStart++;
    ...
    private void checkLocked(RangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        try {
