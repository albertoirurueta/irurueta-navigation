...
public class SequentialRobustMixedRadioSourceEstimator2DTest implements
    ...
    public SequentialRobustMixedRadioSourceEstimator2DTest() { }
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            SequentialRobustMixedRadioSourceEstimator2D<Beacon> estimator =
                    new SequentialRobustMixedRadioSourceEstimator2D<>(
                            qualityScores, readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    @Override
    public void onEstimateStart(SequentialRobustMixedRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        estimateStart++;
        checkLocked((SequentialRobustMixedRadioSourceEstimator2D<WifiAccessPoint>)estimator);
    }

    @Override
    public void onEstimateEnd(SequentialRobustMixedRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        estimateEnd++;
        checkLocked((SequentialRobustMixedRadioSourceEstimator2D<WifiAccessPoint>)estimator);
    }

    @Override
    public void onEstimateProgressChange(SequentialRobustMixedRadioSourceEstimator<WifiAccessPoint, Point2D> estimator,
                                         float progress) {
    ...
    private void checkLocked(SequentialRobustMixedRadioSourceEstimator2D<WifiAccessPoint> estimator) {
        try {
            estimator.setProgressDelta(0.5f);
