...
public class SequentialRobustRangingAndRssiRadioSourceEstimator2DTest implements
    ...
    public SequentialRobustRangingAndRssiRadioSourceEstimator2DTest() { }
    ...
    public void testConstructor() throws LockedException {
        ...
        SequentialRobustRangingAndRssiRadioSourceEstimator2D estimator =
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            int numReadings = randomizer.nextInt(
                    MIN_READINGS, MAX_READINGS);
            Point2D[] readingsPositions = new Point2D[numReadings];
            List<RangingAndRssiReadingLocated2D<Beacon>> readings =
                    new ArrayList<>();
            double[] qualityScores = new double[numReadings];
            for (int i = 0; i < numReadings; i++) {
                readingsPositions[i] = new InhomogeneousPoint2D(
            ...
            SequentialRobustRangingAndRssiRadioSourceEstimator2D<Beacon> estimator =
                    new SequentialRobustRangingAndRssiRadioSourceEstimator2D<>(
                            qualityScores, readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    @Override
    public void onEstimateStart(SequentialRobustRangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        estimateStart++;
        checkLocked((SequentialRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint>)estimator);
    }

    @Override
    public void onEstimateEnd(SequentialRobustRangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        estimateEnd++;
        checkLocked((SequentialRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint>)estimator);
    }

    @Override
    public void onEstimateProgressChange(SequentialRobustRangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator,
                                         float progress) {
    ...
    private void checkLocked(SequentialRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
        try {
            estimator.setProgressDelta(0.5f);
