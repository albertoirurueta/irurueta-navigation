...
public class ECEFKinematicsTest {
    ...
    public void testConstructor() {
        ...
        ECEFKinematics k = new ECEFKinematics();
        ...
        k = new ECEFKinematics(fx, fy, fz, angularRateX, angularRateY, angularRateZ);
        ...
        k = new ECEFKinematics(specificForceX, specificForceY, specificForceZ);
        ...
        k = new ECEFKinematics(angularSpeedX, angularSpeedY, angularSpeedZ);
        ...
        final ECEFKinematics k2 = new ECEFKinematics(k);
    ...
    public void testGetSetFx() {
        final ECEFKinematics k = new ECEFKinematics();
    ...
    public void testSpecificForceNorm() {
        ...
        final ECEFKinematics k = new ECEFKinematics(fx, fy, fz,
    ...
    public void testCopyTo() {
        ...
        final ECEFKinematics k1 = new ECEFKinematics(fx, fy, fz,
                angularRateX, angularRateY, angularRateZ);
    ...
    public void testHashCode() {
        ...
        final ECEFKinematics k1 = new ECEFKinematics(fx, fy, fz,
                angularRateX, angularRateY, angularRateZ);
        final ECEFKinematics k2 = new ECEFKinematics(fx, fy, fz,
                angularRateX, angularRateY, angularRateZ);
