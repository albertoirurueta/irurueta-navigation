...
public class KnownFrameAccelerometerLinearLeastSquaresCalibratorTest implements
    ...
    @Override
    public void onCalibrateStart(KnownFrameAccelerometerLinearLeastSquaresCalibrator calibrator) {
        checkLocked(calibrator);
        mCalibrateStart++;
    }

    @Override
    public void onCalibrateEnd(KnownFrameAccelerometerLinearLeastSquaresCalibrator calibrator) {
        checkLocked(calibrator);
        mCalibrateEnd++;
    }
