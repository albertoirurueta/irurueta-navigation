...
public class LMedSRobustKnownFrameAccelerometerCalibratorTest implements
    ...
    public void testConstructor() throws WrongSizeException {
        ...
        LMedSRobustKnownFrameAccelerometerCalibrator calibrator =
                new LMedSRobustKnownFrameAccelerometerCalibrator();

        // check default values
        assertEquals(calibrator.getStopThreshold(),
                LMedSRobustKnownFrameAccelerometerCalibrator.DEFAULT_STOP_THRESHOLD, 0.0);
    ...
    public void testGetSetStopThreshold() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getStopThreshold(),
                LMedSRobustKnownFrameAccelerometerCalibrator.DEFAULT_STOP_THRESHOLD,
                0.0);
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getPreliminarySubsetSize(),
                LMedSRobustKnownFrameAccelerometerCalibrator.MINIMUM_MEASUREMENTS);
    ...
    public void onCalibrateStart(final RobustKnownFrameAccelerometerCalibrator calibrator) {
        checkLocked((LMedSRobustKnownFrameAccelerometerCalibrator) calibrator);
        mCalibrateStart++;
    }
    ...
    private void checkLocked(final LMedSRobustKnownFrameAccelerometerCalibrator calibrator) {
        try {
