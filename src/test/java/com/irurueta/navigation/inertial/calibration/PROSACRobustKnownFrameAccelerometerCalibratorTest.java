...
public class PROSACRobustKnownFrameAccelerometerCalibratorTest implements
    ...
    public void testConstructor() throws WrongSizeException {
        ...
        PROSACRobustKnownFrameAccelerometerCalibrator calibrator =
                new PROSACRobustKnownFrameAccelerometerCalibrator();

        // check default values
        assertEquals(calibrator.getThreshold(),
                PROSACRobustKnownFrameAccelerometerCalibrator.DEFAULT_THRESHOLD, 0.0);
        assertEquals(calibrator.isComputeAndKeepInliersEnabled(),
                PROSACRobustKnownFrameAccelerometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertEquals(calibrator.isComputeAndKeepResiduals(),
                PROSACRobustKnownFrameAccelerometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
        ...
        calibrator = new PROSACRobustKnownFrameAccelerometerCalibrator(
                true);
        ...
        calibrator = null;
        try {
            calibrator = new PROSACRobustKnownFrameAccelerometerCalibrator(new double[1]);
    ...
    public void testGetSetThreshold() throws LockedException {
        final PROSACRobustKnownFrameAccelerometerCalibrator calibrator =
                new PROSACRobustKnownFrameAccelerometerCalibrator();

        // check default value
        assertEquals(calibrator.getThreshold(),
                PROSACRobustKnownFrameAccelerometerCalibrator.DEFAULT_THRESHOLD,
                0.0);
    ...
    public void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException,
        ...
        final PROSACRobustKnownFrameAccelerometerCalibrator calibrator =
                new PROSACRobustKnownFrameAccelerometerCalibrator(qualityScores,
