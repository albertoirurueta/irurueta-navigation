...
public class PROSACRobustKnownPositionAccelerometerCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        ...
        assertEquals(calibrator.getThreshold(),
                PROSACRobustKnownPositionAccelerometerCalibrator.DEFAULT_THRESHOLD, 0.0);
        assertEquals(calibrator.isComputeAndKeepInliersEnabled(),
                PROSACRobustKnownPositionAccelerometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertEquals(calibrator.isComputeAndKeepResiduals(),
                PROSACRobustKnownPositionAccelerometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    ...
    public void testConstructor5() throws WrongSizeException {
        ...
        calibrator = null;
        try {
            calibrator = new PROSACRobustKnownPositionAccelerometerCalibrator(
                    new double[1]);
    ...
    public void testConstructor42() throws WrongSizeException {
        ...
        PROSACRobustKnownPositionAccelerometerCalibrator calibrator =
                new PROSACRobustKnownPositionAccelerometerCalibrator(qualityScores,
