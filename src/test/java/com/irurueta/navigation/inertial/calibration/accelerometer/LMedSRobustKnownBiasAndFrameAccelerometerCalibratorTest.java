...
public class LMedSRobustKnownBiasAndFrameAccelerometerCalibratorTest implements
    ...
    public void testConstructor() throws WrongSizeException {
        ...
        LMedSRobustKnownBiasAndFrameAccelerometerCalibrator calibrator =
                new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator();

        // check default values
        assertEquals(calibrator.getStopThreshold(),
                LMedSRobustKnownBiasAndFrameAccelerometerCalibrator.DEFAULT_STOP_THRESHOLD, 0.0);
        ...
        calibrator = null;
        try {
            calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(measurements,
                    new Matrix(1, 1), true);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
    ...
    public void testGetSetThreshold() throws LockedException {
        final LMedSRobustKnownBiasAndFrameAccelerometerCalibrator calibrator =
                new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getPreliminarySubsetSize(),
                LMedSRobustKnownBiasAndFrameAccelerometerCalibrator.MINIMUM_MEASUREMENTS);
    ...
    public void onCalibrateStart(final RobustKnownBiasAndFrameAccelerometerCalibrator calibrator) {
        checkLocked((LMedSRobustKnownBiasAndFrameAccelerometerCalibrator) calibrator);
        mCalibrateStart++;
    }
    ...
    private void checkLocked(final LMedSRobustKnownBiasAndFrameAccelerometerCalibrator calibrator) {
        try {
