...
public class PROMedSRobustKnownBiasAndPositionAccelerometerCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        ...
        assertEquals(calibrator.getStopThreshold(),
                PROMedSRobustKnownBiasAndPositionAccelerometerCalibrator.DEFAULT_STOP_THRESHOLD, 0.0);
    ...
    public void testConstructor5() throws WrongSizeException {
        ...
        calibrator = null;
        try {
            calibrator = new PROMedSRobustKnownBiasAndPositionAccelerometerCalibrator(
                    new double[1]);
    ...
    public void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustKnownBiasAndPositionAccelerometerCalibrator calibrator =
                    new PROMedSRobustKnownBiasAndPositionAccelerometerCalibrator(qualityScores,
