...
public class RANSACRobustKnownFrameAccelerometerCalibratorTest implements
    ...
    public void testConstructor() throws WrongSizeException {
        ...
        RANSACRobustKnownFrameAccelerometerCalibrator calibrator =
                new RANSACRobustKnownFrameAccelerometerCalibrator();

        // check default values
        assertEquals(calibrator.getThreshold(),
                RANSACRobustKnownFrameAccelerometerCalibrator.DEFAULT_THRESHOLD, 0.0);
        assertEquals(calibrator.isComputeAndKeepInliersEnabled(),
                RANSACRobustKnownFrameAccelerometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertEquals(calibrator.isComputeAndKeepResiduals(),
                RANSACRobustKnownFrameAccelerometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
        ...
        calibrator = new RANSACRobustKnownFrameAccelerometerCalibrator(this);
        ...
        calibrator = new RANSACRobustKnownFrameAccelerometerCalibrator(measurements);
        ...
        calibrator = new RANSACRobustKnownFrameAccelerometerCalibrator(
                true);
    ...
    public void testGetSetThreshold() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getThreshold(),
                RANSACRobustKnownFrameAccelerometerCalibrator.DEFAULT_THRESHOLD,
                0.0);
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getPreliminarySubsetSize(),
                RANSACRobustKnownFrameAccelerometerCalibrator.MINIMUM_MEASUREMENTS);
    ...
    public void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException,
        ...
        final RANSACRobustKnownFrameAccelerometerCalibrator calibrator =
                new RANSACRobustKnownFrameAccelerometerCalibrator(measurements,
                        false, this);
    ...
    public void onCalibrateStart(final RobustKnownFrameAccelerometerCalibrator calibrator) {
        checkLocked((RANSACRobustKnownFrameAccelerometerCalibrator) calibrator);
        mCalibrateStart++;
    }
    ...
    @Override
    public void onCalibrateNextIteration(final RobustKnownFrameAccelerometerCalibrator calibrator,
                                         final int iteration) {
        checkLocked((RANSACRobustKnownFrameAccelerometerCalibrator) calibrator);
    ...
    @Override
    public void onCalibrateProgressChange(final RobustKnownFrameAccelerometerCalibrator calibrator,
