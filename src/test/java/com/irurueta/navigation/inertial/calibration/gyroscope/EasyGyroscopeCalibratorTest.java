...
public class EasyGyroscopeCalibratorTest implements
        EasyGyroscopeCalibratorListener {
    ...
    public void testConstructor2() throws WrongSizeException {
        ...
        calibrator = null;
        try {
            calibrator = new EasyGyroscopeCalibrator(
                    sequences, new Matrix(1, 1),
                    mg, gg);
