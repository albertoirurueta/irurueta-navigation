...
public class LMedSRobustKnownBiasEasyGyroscopeCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        ...
        assertEquals(calibrator.getProgressDelta(),
                LMedSRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA,
                0.0);
        assertEquals(calibrator.getConfidence(),
                LMedSRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE,
                0.0);
        assertEquals(calibrator.getMaxIterations(),
                LMedSRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS);
        ...
        assertEquals(calibrator.getStopThreshold(),
                LMedSRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_STOP_THRESHOLD,
                0.0);
    ...
    public void testConstructor2() throws WrongSizeException {
        ...
        LMedSRobustKnownBiasEasyGyroscopeCalibrator calibrator =
                new LMedSRobustKnownBiasEasyGyroscopeCalibrator(
                        sequences, bg, mg, gg);
        ...
        calibrator = null;
        try {
            calibrator = new LMedSRobustKnownBiasEasyGyroscopeCalibrator(
    ...
    public void testGetSetStopThreshold() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getStopThreshold(),
                LMedSRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_STOP_THRESHOLD, 0.0);
    ...
    public void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getProgressDelta(),
                LMedSRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, 0.0);
    ...
    public void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getConfidence(),
                LMedSRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, 0.0);
    ...
    public void testCalibrateCommonAxisAndGDependentCrossBiasesDisabledAndNoInlierNoise()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustKnownBiasEasyGyroscopeCalibrator calibrator =
                    new LMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences,
                            true, false,
                            bg, mg, gg, ba, ma, this);
