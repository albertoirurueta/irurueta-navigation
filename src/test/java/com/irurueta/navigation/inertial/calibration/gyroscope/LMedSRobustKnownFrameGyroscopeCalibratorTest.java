...
public class LMedSRobustKnownFrameGyroscopeCalibratorTest
    ...
    public void testConstructor1() throws WrongSizeException {
        final LMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new LMedSRobustKnownFrameGyroscopeCalibrator();

        // check default values
        assertEquals(calibrator.getStopThreshold(),
                LMedSRobustKnownFrameGyroscopeCalibrator.DEFAULT_STOP_THRESHOLD, 0.0);
    ...
    public void testConstructor2() throws WrongSizeException {
        final LMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new LMedSRobustKnownFrameGyroscopeCalibrator(this);
    ...
    public void testConstructor3() throws WrongSizeException {
        ...
        final LMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new LMedSRobustKnownFrameGyroscopeCalibrator(measurements);
    ...
    public void testConstructor4() throws WrongSizeException {
        ...
        final LMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new LMedSRobustKnownFrameGyroscopeCalibrator(measurements, this);
    ...
    public void testConstructor5() throws WrongSizeException {
        final LMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new LMedSRobustKnownFrameGyroscopeCalibrator(true);
    ...
    public void testConstructor6() throws WrongSizeException {
        final LMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new LMedSRobustKnownFrameGyroscopeCalibrator(true, this);
    ...
    public void testConstructor7() throws WrongSizeException {
        ...
        final LMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new LMedSRobustKnownFrameGyroscopeCalibrator(measurements, true);
    ...
    public void testConstructor8() throws WrongSizeException {
        ...
        final LMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new LMedSRobustKnownFrameGyroscopeCalibrator(measurements, true, this);
    ...
    public void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getProgressDelta(),
                LMedSRobustKnownFrameGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, 0.0);
    ...
    public void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getConfidence(),
                LMedSRobustKnownFrameGyroscopeCalibrator.DEFAULT_CONFIDENCE, 0.0);
    ...
    public void testGetSetMaxIterations() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getMaxIterations(),
                LMedSRobustKnownFrameGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS);
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getPreliminarySubsetSize(),
                LMedSRobustKnownFrameGyroscopeCalibrator.MINIMUM_MEASUREMENTS);
