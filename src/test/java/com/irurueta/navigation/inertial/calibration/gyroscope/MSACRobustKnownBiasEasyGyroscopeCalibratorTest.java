...
public class MSACRobustKnownBiasEasyGyroscopeCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        final MSACRobustKnownBiasEasyGyroscopeCalibrator calibrator =
                new MSACRobustKnownBiasEasyGyroscopeCalibrator();
        ...
        assertEquals(calibrator.getProgressDelta(),
                MSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA,
                0.0);
        assertEquals(calibrator.getConfidence(),
                MSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE,
                0.0);
        assertEquals(calibrator.getMaxIterations(),
                MSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS);
        ...
        assertEquals(calibrator.getThreshold(),
                MSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_THRESHOLD,
                0.0);
    ...
    public void testConstructor2() throws WrongSizeException {
        ...
        MSACRobustKnownBiasEasyGyroscopeCalibrator calibrator =
                new MSACRobustKnownBiasEasyGyroscopeCalibrator(
                        sequences, bg, mg, gg);
        ...
        calibrator = null;
        try {
            calibrator = new MSACRobustKnownBiasEasyGyroscopeCalibrator(
    ...
    public void testGetSetThreshold() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getThreshold(),
                MSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_THRESHOLD, 0.0);
    ...
    public void testGetMinimumRequiredMeasurementsOrSequences() throws LockedException {
        ...
        // check
        assertEquals(calibrator.getMinimumRequiredMeasurementsOrSequences(), 7);
        assertTrue(calibrator.isCommonAxisUsed());
        assertFalse(calibrator.isGDependentCrossBiasesEstimated());
    ...
    public void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getProgressDelta(),
                MSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, 0.0);
    ...
    public void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getConfidence(),
                MSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, 0.0);
    ...
    public void testCalibrateCommonAxisAndGDependentCrossBiasesDisabledAndNoInlierNoise()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustKnownBiasEasyGyroscopeCalibrator calibrator =
                    new MSACRobustKnownBiasEasyGyroscopeCalibrator(sequences,
                            true, false,
                            bg, mg, gg, ba, ma, this);
