...
public class MSACRobustKnownFrameGyroscopeCalibratorTest
    ...
    public void testConstructor1() throws WrongSizeException {
        final MSACRobustKnownFrameGyroscopeCalibrator calibrator =
                new MSACRobustKnownFrameGyroscopeCalibrator();

        // check default values
        assertEquals(calibrator.getThreshold(),
                MSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_THRESHOLD, 0.0);
    ...
    public void testConstructor2() throws WrongSizeException {
        final MSACRobustKnownFrameGyroscopeCalibrator calibrator =
                new MSACRobustKnownFrameGyroscopeCalibrator(this);
    ...
    public void testConstructor3() throws WrongSizeException {
        ...
        final MSACRobustKnownFrameGyroscopeCalibrator calibrator =
                new MSACRobustKnownFrameGyroscopeCalibrator(measurements);
    ...
    public void testConstructor4() throws WrongSizeException {
        ...
        final MSACRobustKnownFrameGyroscopeCalibrator calibrator =
                new MSACRobustKnownFrameGyroscopeCalibrator(measurements, this);
    ...
    public void testConstructor5() throws WrongSizeException {
        final MSACRobustKnownFrameGyroscopeCalibrator calibrator =
                new MSACRobustKnownFrameGyroscopeCalibrator(true);
    ...
    public void testConstructor6() throws WrongSizeException {
        final MSACRobustKnownFrameGyroscopeCalibrator calibrator =
                new MSACRobustKnownFrameGyroscopeCalibrator(true, this);
    ...
    public void testConstructor7() throws WrongSizeException {
        ...
        final MSACRobustKnownFrameGyroscopeCalibrator calibrator =
                new MSACRobustKnownFrameGyroscopeCalibrator(measurements, true);
    ...
    public void testConstructor8() throws WrongSizeException {
        ...
        final MSACRobustKnownFrameGyroscopeCalibrator calibrator =
                new MSACRobustKnownFrameGyroscopeCalibrator(measurements, true, this);
    ...
    public void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getProgressDelta(),
                MSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, 0.0);
    ...
    public void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getConfidence(),
                MSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_CONFIDENCE, 0.0);
    ...
    public void testGetSetMaxIterations() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getMaxIterations(),
                MSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS);
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getPreliminarySubsetSize(),
                MSACRobustKnownFrameGyroscopeCalibrator.MINIMUM_MEASUREMENTS);
    ...
    public void onCalibrateStart(RobustKnownFrameGyroscopeCalibrator calibrator) {
        checkLocked((MSACRobustKnownFrameGyroscopeCalibrator) calibrator);
        mCalibrateStart++;
    }
    ...
    private void checkLocked(final MSACRobustKnownFrameGyroscopeCalibrator calibrator) {
