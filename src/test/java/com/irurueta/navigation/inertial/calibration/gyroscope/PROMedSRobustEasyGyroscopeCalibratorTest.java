...
public class PROMedSRobustEasyGyroscopeCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        ...
        assertEquals(calibrator.getProgressDelta(),
                PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA,
                0.0);
        assertEquals(calibrator.getConfidence(),
                PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE,
                0.0);
        assertEquals(calibrator.getMaxIterations(),
                PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS);
        ...
        assertEquals(calibrator.getStopThreshold(),
                PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_STOP_THRESHOLD,
                0.0);
    ...
    public void testConstructor2() throws WrongSizeException {
        ...
        PROMedSRobustEasyGyroscopeCalibrator calibrator =
                new PROMedSRobustEasyGyroscopeCalibrator(
                        sequences, bg, mg, gg);
        ...
        calibrator = null;
        try {
            calibrator = new PROMedSRobustEasyGyroscopeCalibrator(
    ...
    public void testConstructor18() throws WrongSizeException {
        ...
        PROMedSRobustEasyGyroscopeCalibrator calibrator =
                new PROMedSRobustEasyGyroscopeCalibrator(qualityScores);
    ...
    public void testGetSetStopThreshold() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getStopThreshold(),
                PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_STOP_THRESHOLD, 0.0);
    ...
    public void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getProgressDelta(),
                PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, 0.0);
    ...
    public void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getConfidence(),
                PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, 0.0);
    ...
    public void testGetSetQualityScores() throws LockedException {
        ...
        final double[] qualityScores = new double[
                EasyGyroscopeCalibrator.MINIMUM_SEQUENCES_COMMON_Z_AXIS];
        calibrator.setQualityScores(qualityScores);
