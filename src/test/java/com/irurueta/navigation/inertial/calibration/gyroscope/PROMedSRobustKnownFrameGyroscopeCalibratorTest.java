...
public class PROMedSRobustKnownFrameGyroscopeCalibratorTest
    ...
    public void testConstructor1() throws WrongSizeException {
        final PROMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new PROMedSRobustKnownFrameGyroscopeCalibrator();

        // check default values
        assertEquals(calibrator.getStopThreshold(),
                PROMedSRobustKnownFrameGyroscopeCalibrator.DEFAULT_STOP_THRESHOLD, 0.0);
    ...
    public void testConstructor2() throws WrongSizeException {
        final PROMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new PROMedSRobustKnownFrameGyroscopeCalibrator(this);
    ...
    public void testConstructor3() throws WrongSizeException {
        ...
        final PROMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new PROMedSRobustKnownFrameGyroscopeCalibrator(measurements);
    ...
    public void testConstructor4() throws WrongSizeException {
        ...
        final PROMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new PROMedSRobustKnownFrameGyroscopeCalibrator(measurements, this);
    ...
    public void testConstructor5() throws WrongSizeException {
        final PROMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new PROMedSRobustKnownFrameGyroscopeCalibrator(true);
    ...
    public void testConstructor6() throws WrongSizeException {
        final PROMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new PROMedSRobustKnownFrameGyroscopeCalibrator(true, this);
    ...
    public void testConstructor7() throws WrongSizeException {
        ...
        final PROMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new PROMedSRobustKnownFrameGyroscopeCalibrator(measurements, true);
    ...
    public void testConstructor8() throws WrongSizeException {
        ...
        final PROMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new PROMedSRobustKnownFrameGyroscopeCalibrator(measurements, true, this);
    ...
    public void testConstructor9() throws WrongSizeException {
        ...
        PROMedSRobustKnownFrameGyroscopeCalibrator calibrator =
                new PROMedSRobustKnownFrameGyroscopeCalibrator(qualityScores);
        ...
        calibrator = null;
        try {
            calibrator = new PROMedSRobustKnownFrameGyroscopeCalibrator(
                    new double[1]);
    ...
    public void testConstructor12() throws WrongSizeException {
        ...
        calibrator = null;
        try {
            calibrator = new PROMedSRobustKnownFrameGyroscopeCalibrator(new double[1],
                    measurements, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
    ...
    public void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getProgressDelta(),
                PROMedSRobustKnownFrameGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, 0.0);
    ...
    public void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getConfidence(),
                PROMedSRobustKnownFrameGyroscopeCalibrator.DEFAULT_CONFIDENCE, 0.0);
    ...
    public void testGetSetMaxIterations() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getMaxIterations(),
                PROMedSRobustKnownFrameGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS);
