...
public class PROSACRobustEasyGyroscopeCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        ...
        assertEquals(calibrator.getProgressDelta(),
                PROSACRobustEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA,
                0.0);
        assertEquals(calibrator.getConfidence(),
                PROSACRobustEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE,
                0.0);
        assertEquals(calibrator.getMaxIterations(),
                PROSACRobustEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS);
        ...
        assertEquals(calibrator.getThreshold(),
                PROSACRobustEasyGyroscopeCalibrator.DEFAULT_THRESHOLD,
                0.0);
    ...
    public void testConstructor2() throws WrongSizeException {
        ...
        PROSACRobustEasyGyroscopeCalibrator calibrator =
                new PROSACRobustEasyGyroscopeCalibrator(
                        sequences, bg, mg, gg);
    ...
    public void testGetSetThreshold() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getThreshold(),
                PROSACRobustEasyGyroscopeCalibrator.DEFAULT_THRESHOLD, 0.0);
    ...
    public void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getProgressDelta(),
                PROSACRobustEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, 0.0);
    ...
    public void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getConfidence(),
                PROSACRobustEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, 0.0);
