...
public class QuaternionIntegratorTest2 {
    ...
    public void testIntegrateGyroSequence1WithInitialAttitude()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            QuaternionIntegrator2.integrateGyroSequence(sequence, initialAttitude, result);
            result.normalize();
    ...
    public void testIntegrateGyroSequence1WithNoInitialAttitude()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            QuaternionIntegrator2.integrateGyroSequence(sequence, null, result);
            result.normalize();
    ...
    public void testIntegrateGyroSequence2()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            QuaternionIntegrator2.integrateGyroSequence(sequence, result);
            result.normalize();
    ...
    public void testIntegrateGyroSequenceAndReturnNew1()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final Quaternion initialAttitude = ecefFrame1.getCoordinateTransformation()
                    .asRotation().toQuaternion();
            final Quaternion result = QuaternionIntegrator2
