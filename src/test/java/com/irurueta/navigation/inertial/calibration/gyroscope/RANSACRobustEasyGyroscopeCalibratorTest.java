...
public class RANSACRobustEasyGyroscopeCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        final RANSACRobustEasyGyroscopeCalibrator calibrator =
                new RANSACRobustEasyGyroscopeCalibrator();
        ...
        assertEquals(calibrator.getProgressDelta(),
                RANSACRobustEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA,
                0.0);
        assertEquals(calibrator.getConfidence(),
                RANSACRobustEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE,
                0.0);
        assertEquals(calibrator.getMaxIterations(),
                RANSACRobustEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS);
        ...
        assertEquals(calibrator.getThreshold(),
                RANSACRobustEasyGyroscopeCalibrator.DEFAULT_THRESHOLD,
                0.0);
    ...
    public void testConstructor2() throws WrongSizeException {
        ...
        RANSACRobustEasyGyroscopeCalibrator calibrator =
                new RANSACRobustEasyGyroscopeCalibrator(
                        sequences, bg, mg, gg);
        ...
        calibrator = null;
        try {
            calibrator = new RANSACRobustEasyGyroscopeCalibrator(
    ...
    public void testGetSetThreshold() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getThreshold(),
                RANSACRobustEasyGyroscopeCalibrator.DEFAULT_THRESHOLD, 0.0);
    ...
    public void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getProgressDelta(),
                RANSACRobustEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, 0.0);
    ...
    public void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getConfidence(),
                RANSACRobustEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, 0.0);
    ...
    public void testCalibrateCommonAxisAndGDependentCrossBiasesDisabledAndNoInlierNoise()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustEasyGyroscopeCalibrator calibrator =
                    new RANSACRobustEasyGyroscopeCalibrator(sequences,
                            true, false,
                            bg, mg, gg, ba, ma, this);
    ...
    public void onCalibrateStart(
        ...
        checkLocked((RANSACRobustEasyGyroscopeCalibrator) calibrator);
        mCalibrateStart++;
    }
