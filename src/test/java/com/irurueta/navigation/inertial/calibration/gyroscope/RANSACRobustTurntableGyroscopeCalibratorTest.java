...
public class RANSACRobustTurntableGyroscopeCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        final RANSACRobustTurntableGyroscopeCalibrator calibrator =
                new RANSACRobustTurntableGyroscopeCalibrator();

        // check default values
        assertEquals(calibrator.getThreshold(),
                RANSACRobustTurntableGyroscopeCalibrator.DEFAULT_THRESHOLD, 0.0);
        ...
        assertEquals(calibrator.getMinimumRequiredMeasurements(), 19);
    ...
    public void testConstructor2() throws WrongSizeException {
        ...
        RANSACRobustTurntableGyroscopeCalibrator calibrator =
                new RANSACRobustTurntableGyroscopeCalibrator(ecefPosition, rotationRate,
        ...
        calibrator = null;
        try {
            calibrator = new RANSACRobustTurntableGyroscopeCalibrator(ecefPosition,
    ...
    public void testConstructor3() throws WrongSizeException {
        ...
        RANSACRobustTurntableGyroscopeCalibrator calibrator =
                new RANSACRobustTurntableGyroscopeCalibrator(ecefPosition,
                        rotationRate, timeInterval, measurements,
                        bg, mg, gg, this);
    ...
    public void testConstructor18() throws WrongSizeException {
        ...
        RANSACRobustTurntableGyroscopeCalibrator calibrator =
                new RANSACRobustTurntableGyroscopeCalibrator(nedPosition, rotationRate,
                        timeInterval, measurements, bg, mg, gg);
        ...
        calibrator = null;
        try {
            calibrator = new RANSACRobustTurntableGyroscopeCalibrator(nedPosition,
                    0.0, timeInterval, measurements,
                    bg, mg, gg);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
    ...
    public void testConstructor19() throws WrongSizeException {
        ...
        RANSACRobustTurntableGyroscopeCalibrator calibrator =
                new RANSACRobustTurntableGyroscopeCalibrator(nedPosition,
                        rotationRate, timeInterval, measurements,
                        bg, mg, gg, this);
    ...
    public void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getProgressDelta(),
                RANSACRobustTurntableGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, 0.0);
    ...
    public void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getConfidence(),
                RANSACRobustTurntableGyroscopeCalibrator.DEFAULT_CONFIDENCE, 0.0);
    ...
    public void testGetSetMaxIterations() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getMaxIterations(),
                RANSACRobustTurntableGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS);
    ...
    public void testIsReady() throws LockedException {
        ...
        for (int i = 0;
             i < TurntableGyroscopeCalibrator.MINIMUM_MEASUREMENTS_COMMON_Z_AXIS_AND_CROSS_BIASES; i++) {
    ...
    private void checkLocked(final RANSACRobustTurntableGyroscopeCalibrator calibrator) {
