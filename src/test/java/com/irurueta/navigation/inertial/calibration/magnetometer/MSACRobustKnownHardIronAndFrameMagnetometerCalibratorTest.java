...
public class MSACRobustKnownHardIronAndFrameMagnetometerCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        final MSACRobustKnownHardIronAndFrameMagnetometerCalibrator calibrator =
                new MSACRobustKnownHardIronAndFrameMagnetometerCalibrator();

        assertEquals(calibrator.getThreshold(),
                MSACRobustKnownHardIronAndFrameMagnetometerCalibrator.DEFAULT_THRESHOLD,
                0.0);
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getPreliminarySubsetSize(),
                MSACRobustKnownHardIronAndFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS);
    ...
    public void onCalibrateStart(
        ...
        checkLocked((MSACRobustKnownHardIronAndFrameMagnetometerCalibrator) calibrator);
        mCalibrateStart++;
    }
