...
public class PROSACRobustKnownHardIronAndFrameMagnetometerCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        ...
        assertEquals(calibrator.getThreshold(),
                PROSACRobustKnownHardIronAndFrameMagnetometerCalibrator.DEFAULT_THRESHOLD,
                0.0);
        assertEquals(calibrator.isComputeAndKeepInliersEnabled(),
                PROSACRobustKnownHardIronAndFrameMagnetometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertEquals(calibrator.isComputeAndKeepResiduals(),
                PROSACRobustKnownHardIronAndFrameMagnetometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    ...
    public void testConstructor9() throws WrongSizeException {
        final double[] qualityScores = new double[
                PROSACRobustKnownHardIronAndFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS];
        PROSACRobustKnownHardIronAndFrameMagnetometerCalibrator calibrator =
                new PROSACRobustKnownHardIronAndFrameMagnetometerCalibrator(qualityScores);
        ...
        calibrator = null;
        try {
            calibrator = new PROSACRobustKnownHardIronAndFrameMagnetometerCalibrator(
                    new double[1]);
    ...
    public void onCalibrateStart(
        ...
        checkLocked((PROSACRobustKnownHardIronAndFrameMagnetometerCalibrator) calibrator);
        mCalibrateStart++;
    }
