...
public class RANSACRobustKnownHardIronAndFrameMagnetometerCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        ...
        assertEquals(calibrator.getThreshold(),
                RANSACRobustKnownHardIronAndFrameMagnetometerCalibrator.DEFAULT_THRESHOLD,
                0.0);
        assertEquals(calibrator.isComputeAndKeepInliersEnabled(),
                RANSACRobustKnownHardIronAndFrameMagnetometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
        assertEquals(calibrator.isComputeAndKeepResiduals(),
                RANSACRobustKnownHardIronAndFrameMagnetometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getPreliminarySubsetSize(),
                RANSACRobustKnownHardIronAndFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS);
