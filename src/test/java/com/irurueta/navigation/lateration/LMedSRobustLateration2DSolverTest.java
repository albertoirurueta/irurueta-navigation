...
class LMedSRobustLateration2DSolverTest implements RobustLaterationSolverListener<Point2D> {
    ...
    void testConstructor() {
        // empty constructor
        var solver = new LMedSRobustLateration2DSolver();

        // check correctness
        assertEquals(LMedSRobustLateration2DSolver.DEFAULT_STOP_THRESHOLD, solver.getStopThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver((Point2D[]) null, distances));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver(positions, null));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(positions, wrong));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver(shortPositions, shortDistances));

        // constructor with positions, distances and standard deviations
        final var standardDeviations = new double[3];
        solver = new LMedSRobustLateration2DSolver(positions, distances, standardDeviations);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver(null, distances, standardDeviations));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver(positions, null, standardDeviations));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver(positions, distances, (double[]) null));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver(positions, wrong, standardDeviations));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver(positions, distances, wrong));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver(shortPositions, shortDistances, standardDeviations));

        // constructor with positions, distances, standard deviations and listener
        solver = new LMedSRobustLateration2DSolver(positions, distances, standardDeviations, this);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(null, distances,
                standardDeviations, this));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(positions, null,
                standardDeviations, this));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(positions, distances,
                null, this));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(positions, wrong,
                standardDeviations, this));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(positions, distances,
                wrong, this));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(shortPositions,
                shortDistances, standardDeviations, this));

        // constructor with positions, distances and listener
        solver = new LMedSRobustLateration2DSolver(positions, distances, this);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver((Point2D[]) null, distances, this));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver(positions, null, this));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver(positions, wrong, this));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver(shortPositions, shortDistances, this));
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver((Circle[]) null));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(shortCircles));

        // constructor with circles and standard deviations
        solver = new LMedSRobustLateration2DSolver(circles, standardDeviations);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver((Circle[]) null, standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(circles, (double[]) null));
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustLateration2DSolver(shortCircles, standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(circles, wrong));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(null,
                this));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(shortCircles,
                this));

        // constructor with circles, standard deviation and listener
        solver = new LMedSRobustLateration2DSolver(circles, standardDeviations, this);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver((Circle[]) null,
                standardDeviations, this));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(circles,
                null, this));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(shortCircles,
                standardDeviations, this));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration2DSolver(circles, wrong,
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var solver = new LMedSRobustLateration2DSolver();
    ...
    void testSolveNoInlierErrorNoRefinement() throws Exception {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var solver = new LMedSRobustLateration2DSolver(circles, this);
    ...
    private static void checkLocked(final LMedSRobustLateration2DSolver solver) {
