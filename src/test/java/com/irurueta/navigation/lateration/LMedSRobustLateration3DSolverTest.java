...
public class LMedSRobustLateration3DSolverTest implements
    ...
    public LMedSRobustLateration3DSolverTest() { }
    ...
    public void testConstructor() {
        ...
        solver = null;
        try {
            solver = new LMedSRobustLateration3DSolver(null,
                    this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
    ...
    public void testGetSetStopThreshold() throws LockedException {
        LMedSRobustLateration3DSolver solver =
                new LMedSRobustLateration3DSolver();
    ...
    private void checkLocked(LMedSRobustLateration3DSolver solver) {
        try {
