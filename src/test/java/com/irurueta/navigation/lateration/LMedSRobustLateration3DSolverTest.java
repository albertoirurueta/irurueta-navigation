...
class LMedSRobustLateration3DSolverTest implements RobustLaterationSolverListener<Point3D> {
    ...
    void testConstructor() {
        // empty constructor
        var solver = new LMedSRobustLateration3DSolver();
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver((Point3D[]) null,
                distances));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(positions, null));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(positions, wrong));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(shortPositions,
                shortDistances));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(null, distances,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(positions, null,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(positions, distances,
                (double[]) null));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(positions, wrong,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(positions, distances,
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver((Sphere[]) null));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(shortSpheres));
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver((Sphere[]) null,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(spheres, (double[]) null));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(shortSpheres,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(spheres, wrong));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(null,
                this));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(shortSpheres,
                this));
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver((Sphere[]) null,
                standardDeviations, this));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(spheres,
                null, this));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(shortSpheres,
                standardDeviations, this));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustLateration3DSolver(spheres, wrong,
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var solver = new LMedSRobustLateration3DSolver();
    ...
    void testSolveNoInlierErrorNoRefinement() throws Exception {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var solver = new LMedSRobustLateration3DSolver(spheres, this);
    ...
    private static void checkLocked(final LMedSRobustLateration3DSolver solver) {
