...
class MSACRobustLateration2DSolverTest implements RobustLaterationSolverListener<Point2D> {
    ...
    void testConstructor() {
        // empty constructor
        var solver = new MSACRobustLateration2DSolver();
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver((Point2D[]) null,
                distances));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(positions, null));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(positions, wrong));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(shortPositions,
                shortDistances));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(null, distances,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(positions, null,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(positions, distances,
                (double[]) null));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(positions, wrong,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(positions, distances,
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(positions, wrong,
                standardDeviations, this));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(positions, distances, wrong,
                this));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(shortPositions,
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver((Point2D[]) null, distances,
                this));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(positions, null,
                this));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(positions, wrong,
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver((Circle[]) null));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(shortCircles));
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver((Circle[]) null,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(circles, (double[]) null));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(shortCircles,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(circles, wrong));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(null, this));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(shortCircles,
                this));
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver((Circle[]) null,
                standardDeviations, this));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(circles,
                null, this));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(shortCircles,
                standardDeviations, this));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustLateration2DSolver(circles, wrong,
    ...
    void testGetSetThreshold() throws LockedException {
        final var solver = new MSACRobustLateration2DSolver();
    ...
    void testSolveNoInlierErrorNoRefinement() throws Exception {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var solver = new MSACRobustLateration2DSolver(circles, this);
    ...
    @Test
    void testSolveNNoPreliminaryLinearSolverAndNoPreliminarySolutionsRefinement() throws Exception {
        final var randomizer = new UniformRandomizer();
        final var errorRandomizer = new GaussianRandomizer(0.0, STD_OUTLIER_ERROR);
    ...
    private static void checkLocked(final MSACRobustLateration2DSolver solver) {
