...
public class PROMedSRobustLateration3DSolverTest implements
    ...
    public PROMedSRobustLateration3DSolverTest() { }
    ...
    public void testGetSetStopThreshold() throws LockedException {
        PROMedSRobustLateration3DSolver solver =
                new PROMedSRobustLateration3DSolver();
    ...
    public void testSolveNoInlierErrorNoRefinement() throws Exception {
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            PROMedSRobustLateration3DSolver solver =
                    new PROMedSRobustLateration3DSolver(qualityScores,
                            spheres, this);
    ...
    private void checkLocked(PROMedSRobustLateration3DSolver solver) {
        try {
