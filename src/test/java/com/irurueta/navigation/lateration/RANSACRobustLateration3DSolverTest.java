...
class RANSACRobustLateration3DSolverTest implements RobustLaterationSolverListener<Point3D> {
    ...
    void testConstructor() {
        // empty constructor
        var solver = new RANSACRobustLateration3DSolver();
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver((Point3D[]) null,
                distances));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(positions,
                null));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(positions, wrong));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(shortPositions,
                shortDistances));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(null, distances,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(positions, null,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(positions, distances,
                (double[]) null));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(positions, wrong,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(positions, distances,
        ...
        // force IllegalArgumentException
        final var shortCircles = new Sphere[1];
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver((Sphere[]) null));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(shortCircles));
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver((Sphere[]) null,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(spheres,
                (double[]) null));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(shortCircles,
                standardDeviations));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(spheres, wrong));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(null,
                this));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustLateration3DSolver(shortCircles,
                this));
    ...
    void testGetSetThreshold() throws LockedException {
        final var solver = new RANSACRobustLateration3DSolver();
    ...
    void testIsSetComputeAndKeepResidualsEnabled() throws LockedException {
        ...
        // set new value
        solver.setComputeAndKeepResidualsEnabled(!RANSACRobustLateration3DSolver.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    ...
    void testSolveNoInlierErrorNoRefinementNoInlierDataAndNoResiduals() throws Exception {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var solver = new RANSACRobustLateration3DSolver(spheres, this);
    ...
    void testSolveWithInlierErrorWithRefinementWithInlierDataWithResidualsAndStandardDeviations() throws Exception {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var solver = new RANSACRobustLateration3DSolver(spheres, standardDeviations, this);
            solver.setResultRefined(true);
            solver.setComputeAndKeepInliersEnabled(true);
            solver.setComputeAndKeepResidualsEnabled(true);
            solver.setCovarianceKept(true);
    ...
    private static void checkLocked(final RANSACRobustLateration3DSolver solver) {
