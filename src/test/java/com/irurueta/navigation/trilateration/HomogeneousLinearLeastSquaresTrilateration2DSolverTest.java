...
public class HomogeneousLinearLeastSquaresTrilateration2DSolverTest implements TrilaterationSolverListener<Point2D> {
    ...
    public HomogeneousLinearLeastSquaresTrilateration2DSolverTest() { }
    ...
    public void testConstructor() {
        // empty constructor
        HomogeneousLinearLeastSquaresTrilateration2DSolver solver =
                new HomogeneousLinearLeastSquaresTrilateration2DSolver();
        ...
        assertEquals(solver.getType(),
                TrilaterationSolverType.HOMOGENEOUS_LINEAR_TRILATERATION_SOLVER);
        ...
        solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(positions, distances);
        ...
        solver = null;
        try {
            solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(null, distances);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(positions, null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(positions, wrong);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(shortPositions, shortDistances);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(solver);
        ...
        solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(listener);
        ...
        solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(positions, distances, listener);
        ...
        solver = null;
        try {
            solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(null, distances, listener);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(positions, null, listener);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(positions, wrong, listener);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(shortPositions, shortDistances, listener);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(solver);
        ...
        solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(circles);
        ...
        solver = null;
        try {
            solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver((Circle[]) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(shortCircles);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(solver);

        // constructor with circles and listener
        solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(circles, listener);
        ...
        solver = null;
        try {
            solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(null, listener);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new HomogeneousLinearLeastSquaresTrilateration2DSolver(shortCircles, listener);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(solver);
    }
    ...
    public void onSolveStart(TrilaterationSolver<Point2D> solver) {
        solveStart++;
        checkLocked((HomogeneousLinearLeastSquaresTrilateration2DSolver)solver);
    }
    ...
    private void checkLocked(HomogeneousLinearLeastSquaresTrilateration2DSolver solver) {
        try {
