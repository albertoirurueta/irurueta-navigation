...
public class InhomogeneousLinearLeastSquaresTrilateration2DSolverTest implements TrilaterationSolverListener<Point2D> {
    ...
    public InhomogeneousLinearLeastSquaresTrilateration2DSolverTest() { }
    ...
    public void testConstructor() {
        // empty constructor
        InhomogeneousLinearLeastSquaresTrilateration2DSolver solver =
                new InhomogeneousLinearLeastSquaresTrilateration2DSolver();
        ...
        assertEquals(solver.getType(),
                TrilaterationSolverType.INHOMOGENEOUS_LINEAR_TRILATERATION_SOLVER);
        ...
        solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(positions, distances);
        ...
        solver = null;
        try {
            solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(null, distances);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(positions, null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(positions, wrong);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(shortPositions, shortDistances);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(solver);
        ...
        solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(listener);
        ...
        solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(positions, distances, listener);
        ...
        solver = null;
        try {
            solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(null, distances, listener);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(positions, null, listener);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(positions, wrong, listener);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(shortPositions, shortDistances, listener);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(solver);
        ...
        solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(circles);
        ...
        solver = null;
        try {
            solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver((Circle[]) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(shortCircles);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(solver);
        ...
        solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(circles, listener);
        ...
        solver = null;
        try {
            solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(null, listener);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new InhomogeneousLinearLeastSquaresTrilateration2DSolver(shortCircles, listener);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(solver);
    }
    ...
    public void onSolveStart(TrilaterationSolver<Point2D> solver) {
        solveStart++;
        checkLocked((InhomogeneousLinearLeastSquaresTrilateration2DSolver)solver);
    }
    ...
    private void checkLocked(InhomogeneousLinearLeastSquaresTrilateration2DSolver solver) {
        try {
