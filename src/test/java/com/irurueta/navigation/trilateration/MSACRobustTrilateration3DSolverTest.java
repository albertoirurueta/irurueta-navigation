...
public class MSACRobustTrilateration3DSolverTest implements
    ...
    public MSACRobustTrilateration3DSolverTest() { }
    ...
    public void testConstructor() {
        ...
        try {
            solver = new MSACRobustTrilateration3DSolver(positions, null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new MSACRobustTrilateration3DSolver(positions, wrong);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        try {
            solver = new MSACRobustTrilateration3DSolver(shortPositions, shortDistances);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(solver);
        ...
        try {
            solver = new MSACRobustTrilateration3DSolver(shortPositions,
        ...
        try {
            solver = new MSACRobustTrilateration3DSolver(shortSpheres);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(solver);
        ...
        try {
            solver = new MSACRobustTrilateration3DSolver(spheres, wrong);
            fail("IllegalArgumentException expected but not thrown");
        } catch (IllegalArgumentException ignore) { }
        assertNull(solver);
    ...
    public void onSolveStart(RobustTrilaterationSolver<Point3D> solver) {
        solveStart++;
        checkLocked((MSACRobustTrilateration3DSolver)solver);
    }
